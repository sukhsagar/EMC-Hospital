...
<?php include "include/header.php"; ?>
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="flat-cath-labs.php">Flat Cath Labs</a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="facilities-banner/facilities-02.jpg">
    <!-- <div class="container">
        <h1>Flat Cath Labs</h1>
    </div> -->
</div>
...
<p>EMC group of hospitals have high facilitated and well-equipped cath labs to examine the patient’s body. Cath labs consist of highly proficient machinery that are capable of having the visual view of arteries and chambers of the heart.
The patients get the medical imaging of several parts of the heart to treat any stenosis or abnormality found.
</p>

<p> Being a responsible medical facility, EMC group of hospitals highly take care of the aspects like governance, quality, pre-procedure, post-procedure and the clinical quality. </p>

<p>We have 24x7 working labs to detect the health issues that patients are suffering from. Our expert team of lab assistants provides timely reports and best guidance to the patients for further doctor follow-ups.</p>

<p>We make sure that no delay is done in providing detailed information about the problem so that the patient can start with the treatment process as soon as possible</p>
        ...
        <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
            <div class="doc_image_doctorlist">
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/flat-cath-labs.jpg">
