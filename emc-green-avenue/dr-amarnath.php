...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Dr. Amarnath| Internal Medicine Doctor - EMC Hospital</title>
<meta name="title" content="Dr. Amarnath| Internal Medicine Doctor - EMC Hospital">
<meta name="description" content="Dr. Amarnath is an MD in Internal Medicine with total experience of 3 years. He is currently pursuing a fellowship in critical care medicine.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/dr-amarnath.php">
<meta property="og:title" content="Dr. Amarnath| Internal Medicine Doctor - EMC Hospital">
<meta property="og:description" content="Dr. Amarnath is an MD in Internal Medicine with total experience of 3 years. He is currently pursuing a fellowship in critical care medicine.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/dr-amarnath.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/dr-amarnath.php">
<meta property="twitter:title" content="Dr. Amarnath| Internal Medicine Doctor - EMC Hospital">
<meta property="twitter:description" content="Dr. Amarnath is an MD in Internal Medicine with total experience of 3 years. He is currently pursuing a fellowship in critical care medicine.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/dr-amarnath.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/dr-amarnath.php"/>
...
<!-- End Google Tag Manager (noscript) -->
         ...
         <div class="container-fluid bread">
            ...
            <div class="container p-0">
               ...
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Amarnath</a></li>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         ...
         <div class="doctor-img">
            ...
            <img class="img-fluid" alt="User Image" src="doctors/dr-amarnath.jpg">
         ...
         <table border="1" width="100%" class="table-doc">
            ...
            <tr>
               ...
               <td colspan="2">
                  ...
                  <h3 class="doctor-hding">Dr. Amarnath</h3>
      ...
      <div class="table-responsive">
         ...
         <table border="1" width="100%" class="table-doc">
               ...
               <td>
                  ...
                  <div class="cnt-doctorss">
                     ...
                     <ul>
                        ...
                        <li>Diabetes Mellitus ( Type-I, Type-II, Mody, LADA, Diabetic  Ketoacidosis, Diabetic Neuropathy, Gestational Diabetes).</li>

                        <li>Hypertension in  Adults</li>

                        <li>Respiratory Problems ( COPD, Bronchial Asthma, Extrinsic Allergic Alveolitis, Etc,  </li>

                        <li>Heart diseases ( Non Interventional )</li>

                        <li>Chronic Kidney disease</li>

                        <li>Cerebrovascular accidents, Seizure disorders, Trigeminal Neuralgia, Headache ( Migraine etc.)</li>

                        <li>Acid peptic disease, Irritable Bowel Syndrome, Inflammatory Bowel disease.</li>

                        <li>Liver related disorders</li>

                        <li>Infectious diseases (Malaria, Typhoid, tuberculosis, Dengue etc.)</li>

                        <li>Connective tissue disorders (Rheumatoid Arthritis etc.) </li>

                        <li>Gout</li>

                        <li>Autoimmune and Hematological disorders </li>
            ...
            <h5>CERFTIFICATION/ ACHIEVMENTS :</h5>
            ...
            <li>Pursuing Fellowship in critical care medicine from Medvarsity.</li>

            <li>CCIDC ( Critical Care Infections diseases Course) from ISCCM</li>

            <li>Fellowship in cardiology from John Hopkins University</li>

            <li>Certification in Advanced clinical Oncology from Tata Memorial Centre.</li>

            <li>ACLS, BLS, PALS, Certifications from AHA.</li>
