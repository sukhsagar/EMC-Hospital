...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Anesthesia & Critical Care Specialist | Dr. Himanshu Mehta - EMC Hospital</title>
<meta name="title" content="Anesthesia & Critical Care Specialist | Dr. Himanshu Mehta - EMC Hospital">
<meta name="description" content="Anaesthesia & Critical Care specialist Dr. Himanshu Mehta at EMC Group of Hospital. Expertise in handling emergency situations tactically.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/dr-himanshu_mehta.php">
<meta property="og:title" content="Anesthesia & Critical Care Specialist | Dr. Himanshu Mehta - EMC Hospital">
<meta property="og:description" content="Anaesthesia & Critical Care specialist Dr. Himanshu Mehta at EMC Group of Hospital. Expertise in handling emergency situations tactically.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/Dr-Himanshu-mehta.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/dr-himanshu_mehta.php">
<meta property="twitter:title" content="Anesthesia & Critical Care Specialist | Dr. Himanshu Mehta - EMC Hospital">
<meta property="twitter:description" content="Anaesthesia & Critical Care specialist Dr. Himanshu Mehta at EMC Group of Hospital. Expertise in handling emergency situations tactically.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/Dr-Himanshu-mehta.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/dr-himanshu_mehta.php"/>
...
<!-- End Google Tag Manager (noscript) -->
         ...
         <div class="container-fluid bread">
            ...
            <div class="container p-0">
               ...
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Himanshu Mehta</a></li>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         ...
         <div class="doctor-img">
            ...
            <img class="img-fluid" alt="User Image" src="doctors/Dr-Himanshu-mehta.jpg">
         ...
         <table border="1" width="100%" class="table-doc">
            ...
            <tr>
               ...
               <td colspan="2">
                  ...
                  <h3 class="doctor-hding">Dr. Himanshu Mehta</h3>
            ...
            <tr>
               ...
               <td>
                  ...
                  <p>MBBS , MD (Anaesthesiology & Critical Care) </p>
      ...
      <div class="table-responsive">
         ...
         <table border="1" width="100%" class="table-doc">
            ...
            <tr>
               ...
               <td>
                  ...
                  <div class="cnt-doctorss">
					...
					<li>Presently Working with EMC Group of Hospitals, Amritsar </li>

					<li>Presently Working with EMC Group of Hospitals, Amritsar </li>

					<li>Junior Resident (Non PG) in GMSH 16 CHD as House Surgeon in Medicine Department for 6 months. </li>

					<li>Emergency medical officer in GMSH 16 CHD for a period of 1 year and 10 months.</li>

					<li>Worked as a Senior Resident in Alchemist Hospital Panchkula for two months.</li>
           ...
           <ul>
					...
					<li>Basic life support & Advanced Cardiac Life Support </li>

					<li>Venepuncture / Central vein Cannulation</li>

					<li>Peripheral Artery Cannulation (Adult and Paediatric) </li>

					<li>Epidural catheterization (Lumbar and Thoracic</li>

					<li>Central Neuraxial Blocks and Peripheral nerve Blocks including</li>

					<li>Nasotracheal and Endotracheal intubations (Adult, Pediatric and Neonatal) </li>

					<li>Retrograde intubations</li>

					<li>SurgicalTracheostomy</li>

					<li>Management of Ventilators and its accessories, Transportation of critically ill patients</li>

					<li>Management of difficult airway and Labor Analgesia .</li>
