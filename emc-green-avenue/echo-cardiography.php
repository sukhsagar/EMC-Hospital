...
<?php include "include/header.php"; ?>
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="echo-cardiography.php">Echo Cardiography</a></li>
 ...
 <div class="spec-banner">
    <div class="banner-gredient"></div>
     <img src="facilities-banner/facilities-05.jpg">
    <!-- <div class="container">
        <h1>Echo Cardiography</h1>
    </div> -->
</div>
...
<p>EMC hospitals are all fully equipped to treat heart patients. Our hospitals are facilitated with machines for performing echocardiography. 
 </p>

 <p>This facility is available 24x7 for every and any patient. We have an expert team of staff to perform the accurate cardiography and deliver the right images of the heart without any delay. You can avail of this medical facility at the most affordable price at our EMC hospitals.</p>

<p>Timely report generation helps the patients to get their diagnosis and treatment process started immediately and get all their health issues resolved. </p>

</div>
</div>
        <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
            <div class="doc_image_doctorlist">
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/eco.jpg">
