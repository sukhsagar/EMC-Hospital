...
<html lang="en">
   ...
   <head>
      ...
      <title>Emergency & Trauma Care Centre in Amritsar</title>

      <meta name="title" content="Emergency & Trauma Care Centre in Amritsar">

      <meta name="description" content="One of the leading care units of Amritsar deals with traumatic and emergency patients. The utmost care and attention are given to every individual under critical conditions.">

      <!-- Open Graph / Facebook -->

      <meta property="og:type" content="website">

      <meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/critical-trauma-care.php">

      <meta property="og:title" content="Emergency & Trauma Care Centre in Amritsar">

      <meta property="og:description" content="One of the leading care units of Amritsar deals with traumatic and emergency patients. The utmost care and attention are given to every individual under critical conditions.">
      ...
      <meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/critical-trauma-care.php">

      <meta property="twitter:title" content="Emergency & Trauma Care Centre in Amritsar">

      <meta property="twitter:description" content="One of the leading care units of Amritsar deals with traumatic and emergency patients. The utmost care and attention are given to every individual under critical conditions.">

      <meta property="twitter:image" content="">

      <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/critical-trauma-care.php"/>
   ...
   <body>
         ...
         <div class="container-fluid bread">
            ...
            <div class="container p-0">
               ...
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="critical-trauma-care.php">Department of Emergency & Trauma Care </a></li>
      ...
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/critical-trauma-care.jpg">

         <!--    <div class="container">

            <h1>Department of Emergency & Trauma Care </h1>
            ...
            <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="doc-cardx">
                         ...
                         <div class="doc_image_doctorlist">
                              ...
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Pankaj Soni" data-speciality="Anaesthesia" data-hospital="Hospital EMC" href="#" target="_blank">
               ...
               <div class="overview" id="about_doclistingpage" style="padding-left:0px!important;">
                  ...
                  <p>The critical care unit of the hospital deals with the patients that are suffering from sudden and potentially life-threatening injuries and diseases. Any person who has met with an accident, or needs immediate surgical treatments, suffering from infections or coma are admitted to the critical care unit of the hospitals.</p>

                  <p> Also, there exists a further division within the critical care unit that is the intensive care unit that looks after the sickest patients, and the other is a high dependency that houses the patients, which are well enough to treat in general wards.    </p>

                  <p>The Department of Critical Care Medicines is one of the leading critical care units in Amritsar, located on the 3rd floor of EMC Hospital, well equipped with 50 beds.</p>

                  <p>Our specialist areas of intensive care include neurosurgery, respiratory, gastroenterology, emergency, nephrology, orthopaedic, plastic and reconstructive surgeries, urology, general surgery, and neurological conditions.  </p>

                  <p>The Cardiology department of EMC hospital provides intensive care for heart and cardiothoracic surgery.</p>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/critical-trauma-care/dedicated-team-for-trauma-critical-patient.png" alt="">

                              </div>

                              <h4 style="color: #28ace2;">Dedicated Team for Trauma Critical Patient</h4>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/critical-trauma-care/poly-trauma-management.png" alt="">

                              </div>

                              <h4 style="color: #e0742d;">Poly Trauma Management</h4>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/critical-trauma-care/snake-bite-poison-management.png" alt="">

                              </div>

                              <h4 style="color: #49b848;">Snake Bite Poison Management</h4>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/critical-trauma-care/well-equipped-emergency-department.png" alt="">

                              </div>

                              <h4 style="color: #000;">Well Equipped Emergency Department
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               ...
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     ...
                     <input id="discipline" name="department" type="hidden" value="Emergency & Trauma Care">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Emergency & Trauma Care" required="">
