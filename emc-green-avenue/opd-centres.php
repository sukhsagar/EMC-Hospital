...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>OPD Centers - EMC Hospital</title>
<meta name="title" content="OPD Centers - EMC Hospital">
<meta name="description" content="EMC Hospital has a number of OPD centers in different cities including Jammu, Tarn Taran, Batala, Gurdaspur, and many more.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/opd-centres.php">
<meta property="og:title" content="OPD Centers - EMC Hospital">
<meta property="og:description" content="EMC Hospital has a number of OPD centers in different cities including Jammu, Tarn Taran, Batala, Gurdaspur, and many more.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/our-opd-centres.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/opd-centres.php">
<meta property="twitter:title" content="OPD Centers - EMC Hospital">
<meta property="twitter:description" content="EMC Hospital has a number of OPD centers in different cities including Jammu, Tarn Taran, Batala, Gurdaspur, and many more.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/our-opd-centres.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/opd-centres.php"/>
...
<!-- End Google Tag Manager (noscript) -->
      ...
      <div class="container-fluid padding-0 margin-0">
         ...
         <div class="spec-banner">
            ...
            <img src="assets/web-banners/our-opd-centres.jpg">
            <!--  <div class="container">
         ...
         <div class="container">
            <div class="contentarea chairman-mr-top">
			   ...
			   <div class="row">
               <div class="col-sm-6 chphotom">
				  <div class="cstm-opd">
					<img src="images/opd cenetr icon-02.jpg" class="img-responsive">
				  </div>
                  <div class="charea">
                     <h2>Mr. Gurmeet Singh Dhillon</h2>
                      <p><strong>Location :  </strong>  Jammu </p>
                  <p><strong>Address :  </strong> Block-A, 80 B, Main Stop, <br>Near Gurudwara Fateh Singh, Gandhinagar, Jammu</p>
                  <p><strong>Contact No: </strong> 9814488677, 9501003330</p>
                  <p><strong>Email ID:</strong>  emchelpline@gmail.com</p>
                  </div>
               </div>
               <div class="col-sm-6">
				  <div class="cstm-opd">
					<img src="images/opd cenetr icon-04.jpg" class="img-responsive">
				  </div>
				    <div class="charea">
                     <h2>Mr. Gurpal Singh Tung  </h2>
                     <p><strong>Location :  </strong>  Tarn Taran Sahib  </p>
                  <p><strong>Address :  </strong> Chhibber Health Care Centre, <br> Mohalla Bhag Shah,  Tarn Taran</p>
               ...
               <div class="col-sm-6 chphotom">
			      <div class="cstm-opd">
					<img src="images/opd cenetr icon-01.jpg" class="img-responsive">
				  </div>
					 <div class="charea">
						 <h2>Mr. Sandeep Chuhan </h2>
						 <p><strong>Location : </strong>Gurdaspur  </p>
                  <p><strong>Address :  </strong> SCO-10, Batala, Road, Near Indian Bank, Gurdaspur </p>
               ...
               <div class="col-sm-6">
                   <div class="cstm-opd">
					<img src="images/opd cenetr icon-03.jpg" class="img-responsive">
				  </div>
					 <div class="charea">
						 <h2>Mr. Jaspinder Singh </h2>
						 <p><strong>Location : </strong>Batala  </p>
                  <p><strong>Address :  </strong>Near OM Medico, OM Parkash Market, Civil Hospital, Jalandhar Road, Batala.</p>
                  <p><strong>Contact No: </strong> 9417370897</p>
                  <p><strong>Email ID:</strong> emchelpline@gmail.com</p>
					  </div>
               </div>
			   </div>
