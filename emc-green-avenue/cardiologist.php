...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Best Cardiothoracic Surgery Specialists in Amritsar | EMC Hospital</title>
<meta name="title" content="Best Cardiothoracic Surgery Specialists in Amritsar | EMC Hospital">
<meta name="description" content="EMC Hospital has one of the best Cardiac Surgeons/ Cardio Thoracic Vascular Surgeons in Amritsar. EMC has a dedicated team of professionals to cure cardiac problems.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/cardiologist.php">
<meta property="og:title" content="Best Cardiothoracic Surgery Specialists in Amritsar | EMC Hospital">
<meta property="og:description" content="EMC Hospital has one of the best Cardiac Surgeons/ Cardio Thoracic Vascular Surgeons in Amritsar. EMC has a dedicated team of professionals to cure cardiac problems.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/cardiothoracic.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/cardiologist.php">
<meta property="twitter:title" content="Best Cardiothoracic Surgery Specialists in Amritsar | EMC Hospital">
<meta property="twitter:description" content="EMC Hospital has one of the best Cardiac Surgeons/ Cardio Thoracic Vascular Surgeons in Amritsar. EMC has a dedicated team of professionals to cure cardiac problems.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/cardiothoracic.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/cardiologist.php"/>
...
<?php include "include/header.php"; ?>
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="cardiologist.php">Department of Cardiothoracic Surgery</a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="assets/web-banners/cardiothoracic.jpg">
   <!--  <div class="container">
        <h1>Department of Cardiothoracic Surgery</h1>
    </div> -->
</div>
...
<img class="img-responsive" width="100%" src="doctors/dr-sameer-goyal.jpg">
<a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Sameer Goyal" data-speciality="Cardiologist" data-hospital="Hospital EMC" href="#" target="_blank">
<button>Book an appointment</button>
</a>     
</div>
<div class="doc-details">
<h5>Dr.Sameer Goyal</h5>
<p >MBBS, MS Surgery, M.ch <br>(Cardiac & Thoracic Surgery)</p>
...
<div class="doc_image_doctorlist">
<img class="img-responsive" width="100%" src="doctors/dr-dp-marik.jpg">
<a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.DP Marik" data-speciality="Cardiologist" data-hospital="Hospital EMC" href="#" target="_blank">
<button>Book an appointment</button>
</a>     
</div>
<div class="doc-details" >
...
<div class="clearfix"></div>
                 ...
                 <div class="overview" id="about_doclistingpage" style="padding-left:0px;">

                     <p>Cardiothoracic and vascular intensive care unit of the hospital is responsible for treating all the adult patients suffering from any kind of condition related to the heart.</p>

                     <h4>What is the Cardiothoracic and Vascular Surgery Intensive Care Unit (CTVS ICU)?</h4> 

                     <p> CTVS ICU is an intensive care unit for patients going through surgical treatments. All the patients are under thorough examination of cardiothoracic intensive care consultants. </p> 

                     <p>Cardiothoracic and vascular intensive care refers to the special attention given to patients with potentially reversible, acute, life-threatening cardiac, thoracic, or vascular-related conditions.</p>

                     <h4>Who is admitted to CTVS ICU?</h4>

                     <strong>Patients admitted to CTVS ICU may include the following surgical patients:</strong>

                     <ul>
                         <li>The patients undergoing intra-cardiac or coronary bypass surgery</li>
                         <li>The patients undergoing thoracic aortic or aortic arch surgery</li>
                         <li>The patients underwent surgery for ruptured abdominal aortic aneurysms</li>
                         <li>The patients underwent primary vascular operations</li>
                         <li>The patients housing massive pulmonary embolism</li>
                         <li>The patients who had either a coronary stent deployed or are intubated</li>
                         <li>The patients who had intra-aortic balloon pumps inserted</li>

                     </ul>

                     <h4>Who may be considered for admission to CTVS ICU?</h4>

                     <ul>
                        <li>Adults undergoing non-bypass operations, usually vascular or thoracic surgery</li>
                        <li>Patients of heart or lung transplants who require intensive care</li>
                        <li>Patients who require extracorporeal membrane oxygenation therapy</li>
                        <li>Patients undergoing treatment of left ventricular assist device</li>

                     </ul>

                     <p>Before getting admitted, patients must consider the following factors : 
                     physiological reserve and biological age, the preceding chronic health status and quality of life, the severity of illness and probability of reversibility, and anticipated disability.
                       </p>
                            ...
                            <div class="col-md-10 col-md-offset-1 col-sm-12 col-6">
                             ...
                             <div class="col-md-4 col-sm-4 col-6">
                                   ...
                                   <div class="home-specility-section cardiology-four">
                                         ...
                                         <img src="icons-scope/cardiologist/coronary-bypass-surgery.png" alt="">
                                         </div>
                                        <h4 style="color: #2995ec;">Coronary Byepass Surgery</h4>
                                     </div>
                                     </a>
                             </div>
             ...
             <div class="col-md-4 col-sm-4 col-6">
                <a href="#">
                    <div class="home-specility-section cardiology-four">
                        <div class="home-speciality-img services-Cardiology">
                            <img src="icons-scope/cardiologist/open-heart-surgery.png" alt="">
                        </div>
                        <h4 style="color: #000;">Open Heart Surgery</h4>
                    </div>
                </a>
            </div>
             ...
             <div class="col-md-4 col-sm-4 col-6">
                <a href="#">
                    <div class="home-specility-section cardiology-four">
                        <div class="home-speciality-img services-Cardiology">
                            <img src="icons-scope/cardiologist/valve-replacement-surgery.png" alt="">
                        </div>
                        <h4 style="color: #df8188;">Valve Replacement Surgery</h4>
                    </div>
                </a>
            </div>
           <div class="clearfix"></div>
           <br>
              ...
              <div class="col-md-4 col-sm-4 col-6">
                <a href="#">
                    <div class="home-specility-section cardiology-four">
                        <div class="home-speciality-img services-Cardiology">
                            <img src="icons-scope/cardiologist/aortic-dissection.png" alt="">
                        </div>
                        <h4 style="color: #b71411;">Aortic Dissection
                        </h4>
                    </div>
                </a>
            </div>
              ...
              <div class="col-md-4 col-sm-4 col-6">
                <a href="#">
                    <div class="home-specility-section cardiology-four">
                        <div class="home-speciality-img services-Cardiology">
                            <img src="icons-scope/cardiologist/lung-cancer.png" alt="">
                        </div>
                        <h4 style="color: #eb7a74;">Lung Cancer
                        </h4>
                    </div>
                </a>
            </div>
             <div class="col-md-4 col-sm-4 col-6">
                <a href="#">
                    <div class="home-specility-section cardiology-four">
                        <div class="home-speciality-img services-Cardiology">
                            <img src="icons-scope/cardiologist/mediastinal-tumors.png" alt="">
                        </div>
                        <h4 style="color: #7ca6d8;">Mediastinal Tumours
                        </h4>
                    </div>
                </a>
            </div>
       ...
       <div class="clearfix"></div>
           <br>
            ...
            <input id="discipline" name="department" type="hidden" value="Cardiothoracic Surgery">
        ...
        <div class="row padding-35 m-0" style="margin:0;">
             ...
             <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12 ">
                 ...
                 <div class="overview" id="about_doclistingpage">
                     ...
                     <p>The cardiothoracic and vascular intensive care unit of the hospital is responsible for treating all the adult patients suffering from any kind of condition related to the heart.</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Cardiothoracic Surgery" required="">
