...
<html lang="en">
   ...
   <head>
      ...
      <title>Best Anaesthesia Doctors in Amritsar | EMC Hospital</title>

      <meta name="title" content="Best Anaesthesia Doctors in Amritsar | EMC Hospital">

      <meta name="description" content="EMC Hospital has one of the best Anaesthesiologists. Get one of the best treatments by experienced Anaesthesia doctors. Book an appointment now!">

      <!-- Open Graph / Facebook -->

      <meta property="og:type" content="website">

      <meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/anaesthesia.php">

      <meta property="og:title" content="Best Anaesthesia Doctors in Amritsar | EMC Hospital">

      <meta property="og:description" content="EMC Hospital has one of the best Anaesthesiologists. Get one of the best treatments by experienced Anaesthesia doctors. Book an appointment now!">
      ...
      <meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/anaesthesia.php">

      <meta property="twitter:title" content="Best Anaesthesia Doctors in Amritsar | EMC Hospital">

      <meta property="twitter:description" content="EMC Hospital has one of the best Anaesthesiologists. Get one of the best treatments by experienced Anaesthesia doctors. Book an appointment now!">

      <meta property="twitter:image" content="">

      <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/anaesthesia.php"/>
      ...
      <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
         ...
         })(window,document,'script','dataLayer','GTM-PZMZK9K');
   ...
   <body>
         ...
         <div class="container-fluid bread">
            ...
            <div class="container p-0">
               ...
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="anaesthesia.php">Department of Critical Care & Anaesthesia </a></li>
      ...
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/anaesthesiology.jpg">

         <!-- <div class="container">

            <h1>Department of Critical Care & Anaesthesia </h1>
               ...
               <div class="row">
                ...
                <!-- <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/dr.vardevsingh.jpg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Vardev Singh" data-speciality="Anaesthesia" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
                               <h5>Dr. Vardev Singh</h5>
                               <p >MBBS, DA Anaesthesia</p>
                               <p ><a href="mailto:emc.treatment@gmail.com"> <i class="fa fa-envelope" aria-hidden="true"></i> emc.treatment@gmail.com</a></p>
                          </div>
...
<div class="doc-cardx">
      ...
      <div class="clearfix"></div>
            	...
            	<!-- <div class="col-md-4 col-lg-4 col-xs-12" style="background: #f0f0f0; padding: 10px;border-radius: 10px">

				<div class="doc_image_doctorlist">

                  <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-pankaj-soni.jpg">
                  ...
                  <h1>Dr.Pankaj Soni </h1>

                  <p class="doctor_degree hdeading">MD, Anaesthesia Medical Director</p>

                  <p class="doctor_degree hdeading"> <i style="font-size: 20px;" class="fa fa-envelope" aria-hidden="true"></i> emc.treatment@gmail.com</p>
			    ...
			    <div class="col-md-4 col-lg-4 col-xs-12" style="background: #f0f0f0; padding: 10px;border-radius: 10px;margin-bottom:10px">

				<div class="doc_image_doctorlist">

                  <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr.vardevsingh.jpg">

                  <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Vardev Singh" data-speciality="MD Anaesthesia" data-hospital="Hospital EMC" href="#" target="_blank">

                  <button>Book an appointment</button>

                  </a>                

                  <h1>Dr.Vardev Singh </h1>

                  <p class="doctor_degree">MBBS, DA Anaesthesia</p>

                  <p class="doctor_degree"> <i style="font-size: 20px;" class="fa fa-envelope" aria-hidden="true"></i>emc.treatment@gmail.com</p>
				...
				<div class="doc_image_doctorlist">
                  ...
                  <img class="img-responsive singlehimg" width="100%" style="border-radius: 3px;" src="doctors/Dr-Himanshu Mehta.jpg">
                  ...
                  <h1>Dr. Himanshu Mehta </h1>

                  <p class="doctor_degree">MBBS, MD(Anesthesia & Critical Care)</p>
              ...
              <br>
               ...
               <div class="overview" id="about_doclistingpage">
                  ...
                  <p>Anaesthesia is the most crucial step for performing any surgery. It is performed to facilitate pain-free surgery, and the operation ends successfully. The anaesthetic specialists make sure that the dose of anaesthesia injected in the patient’s body is not harmful. We prioritise the patient’s safety before, during, and after the surgery.</p>

                  <p> The anaesthesia process can take either ten minutes or an hour to complete and make sure that the patient is adequately and appropriately anaesthetised before the surgery starts off.</p>

                  <p>The anaesthetic modality may be any one or a mixture of general anaesthesia, sedation, local anaesthesia or “regional anaesthesia” - where individual nerves or parts of the body are anaesthetised specifically.</p>

                  <p>To ensure the patient’s stability and comfort, an anaesthetist always remains in the operation theatre.</p>

                  <p>Once the surgery is finished, patients are transferred to the recovery Room and further monitored to ensure they are remaining stable. Patients will usually spend an hour in the recovery area prior to being returned to the ward/ CU. </p>

                  <p>Our expert doctors, <strong>Dr. Pankaj Soni & Dr. Tajinder Singh</strong> are highly experienced anaesthetists under whose supervision large numbers of successful operations have been conducted.</p>

                  <div class="row department-of">

                     <div class="col-md-10 col-md-offset-1 col-sm-12 col-6">

                        <!--  <h2 class="text-center btn-m3">Scope of Services </h2> -->

                        <img src="images/scope-01.png" class="img-responsive" alt="">
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">

                                 <img src="icons-scope/anaesthesia/bedded-icu-with-state-of-arrt-equipments.png" alt="">

                              </div>

                              <h4 style="color: #000;">50 Bedded ICU With State Of Art Equipments</h4>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/abg.png" alt="">

                              </div>

                              <h4 style="color: #ec1a23;">ABG</h4>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/accident-trauma-care.png" alt="">

                              </div>

                              <h4 style="color: #731612;">Accident Trauma Care</h4>
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/bedside.png" alt="">

                              </div>

                              <h4 style="color: #299bd6;">Bedside ECHO
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/bronchoscopy.png" alt="">

                              </div>

                              <h4 style="color: #eb7a74;">Bronchoscopy
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/endoscopy.png" alt="">

                              </div>

                              <h4 style="color: #11753b;">Endoscopy
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/iabsp-support.png" alt="">

                              </div>

                              <h4 style="color: #f79521;">IABP Support
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/poison-management.png" alt="">

                              </div>

                              <h4 style="color: #b44055;">Poison Management
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/snake- animal-bite.png" alt="">

                              </div>

                              <h4 style="color: #dc5d27;">Snake  Animal Bite
                        ...
                        <a href="#">
                           ...
                           <div class="home-specility-section cardiology-four">
                              ...
                              <div class="home-speciality-img services-Cardiology">
                                 ...
                                 <img src="icons-scope/anaesthesia/tertiary-care-for-sick-patient.png" alt="">

                              </div>

                              <h4 style="color: #0c7552;">Tertiary Care for Sick Patient
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               ...
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     ...
                     <input id="discipline" name="department" type="hidden" value="Critical Care & Anaesthesia">
         ...
         <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
               ...
               <h1>Watch videos of our expert doctors</h1>

               <div class="Testimonials" id="video_doclistingpage">

                  <div class="row video-doctor m-0">

                     <div class=" col-lg-4 col-sm-4 col-md-4 col-xs-12 doctor-videos-text-style vid-section">

                        <div class="doctor-dot-img">

                           <div class="doc-video-img">

                              <img data-toggle="modal" onclick="playVids0();" data-target="#myModal0" src="assets/images/07.jpg">

                              <p>MD, Anaesthesia Medical Director</p>

                              <div class="youtube-icon">

                                 <img data-toggle="modal" onclick="playVids0();" data-target="#myModal0" src="assets/images/you2.png">
                           ...
                           <div class="modal" id="myModal0" onclick="pauseVids0()">
                              ...
                              <div class="modal-dialog">
                                 ...
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                       ...
                                       <button type="button" class="close blog_video_close" data-dismiss="modal">×</button>

                                       <div>

                                          <iframe width="100%"  height="315" src="https://www.youtube.com/embed/kfnLgK3NhWk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                                          <!-- <iframe width="100%" id="yutube-vid0" height="315" src="https://www.youtube.com/embed/l09p6b-QCEk?enablejsapi=1&amp;origin=https%3A%2F%2Fwww.asterbangalore.com" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" data-gtm-yt-inspected-8433319_44="true"></iframe> -->
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-18s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-20s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-19s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/cardiac-recovery.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-23s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-17s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-13s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-16s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-11s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/gaelly-25s.jpg"
                  ...
                  <div class="item-holder">
                     ...
                     <a>
                        ...
                        <div class="item-holder">
                           ...
                           <img src="infrastructure/private-room.jpg"
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close doccallclosesss" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Critical Care & Anaesthesia" required="">
            ...
            <textarea class="form-control" name="message" id="pe5" placeholder="Message"></textarea>
