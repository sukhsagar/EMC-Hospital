...
<title>Professional Team of Laparoscopic Surgeon in Amritsar | EMC Hospital</title>

<meta name="title" content="Professional Team of Laparoscopic Surgeon in Amritsar | EMC Hospital">

<meta name="description" content="The laparoscopic surgery department performs open and minimally invasive surgeries. EMC group of hospitals have the best-skilled surgeons in the region.">
...
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/laparoscopic-surgery.php">

<meta property="og:title" content="Professional Team of Laparoscopic Surgeon in Amritsar | EMC Hospital">

<meta property="og:description" content="The laparoscopic surgery department performs open and minimally invasive surgeries. EMC group of hospitals have the best-skilled surgeons in the region.">
...
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/laparoscopic-surgery.php">

<meta property="twitter:title" content="Professional Team of Laparoscopic Surgeon in Amritsar | EMC Hospital">

<meta property="twitter:description" content="The laparoscopic surgery department performs open and minimally invasive surgeries. EMC group of hospitals have the best-skilled surgeons in the region.">

<meta property="twitter:image" content="">

  

 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/laparoscopic-surgery.php"/>
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <div class="container-fluid bread">
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="laparoscopic-surgery.php">Department of General & Laproscopic Surgery</a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="assets/web-banners/general-laparoscopic-surgery.jpg">

  <!--   <div class="container">

        <h1>Department of General & Laproscopic Surgery</h1>
...
<p>EMC  Hospitals  Department of  General  Surgery has some of the most renowned surgeons in the region. </p>


<p>The department performs open and minimally invasive surgeries: the general surgery and laparoscopic department of the hospital boast of the best surgical  outcomes in  the state.  </p> 

<p>The hospital is privileged  to have  consultants skilled  at laparoscopic surgery from renowned   international institutes.</p>
   ...
   <!--  <h2 class="text-center btn-m3">Scope of Services </h2> -->
    ...
    <br>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/invasive-technique.png" alt="">

                        </div>

                        <h4 style="color: #254c23;">All types of hernia (with minimal Invasive technique)</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/appendectomy.png" alt="">

                        </div>

                        <h4 style="color: #34489e;">Appendectomy</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/cholecystectomy-open-laparoscopic.png" alt="">

                        </div>

                        <h4 style="color: #e57e3f;">Cholecystectomy ( Open _ Laparoscopic)</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/hemorrhoids-piles-surgery.png" alt="">

                        </div>

                        <h4 style="color: #b58c2d;">Hemorrhoids Piles Surgery
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/hysterectomy.png" alt="">

                        </div>

                        <h4 style="color: #1bb4b7;">Hysterectomy
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/laparotomy.png" alt="">

                        </div>

                        <h4 style="color: #b5489b;">Laparotomy
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/laparoscopic-surgery/splenectomy.png" alt="">

                        </div>

                        <h4 style="color: #f57f27;">Splenectomy
        ...
        <div class="form-pages_contact">
                ...
                <input id="discipline" name="department" type="hidden" value="General & Laparoscopic Surgery">
          ...
          <!-- <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                ...
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-asif-mehraj.jpg">

                



                <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Asif Mehraj" data-speciality="Laparoscopic Surger" data-hospital="Hospital EMC" href="#" target="_blank">

                    <button>Book an Appointment</button>

                </a>                <h1>Dr.Asif Mehraj</h1>

                <p class="doctor_degree">(M.S General Surgery) F.C.R.S Colorectal Surgery</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="General & Laparoscopic Surgery" required="">
