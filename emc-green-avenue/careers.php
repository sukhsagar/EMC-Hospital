...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Job application form - EMC Hospital</title>
<meta name="title" content="Job application form - EMC Hospital">
<meta name="description" content="Make your career with EMC Hospitals. Check the vacancies available and fill the job application form to enhance your career with us.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/careers.php">
<meta property="og:title" content="Job application form - EMC Hospital">
<meta property="og:description" content="Make your career with EMC Hospitals. Check the vacancies available and fill the job application form to enhance your career with us.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/career.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/careers.php">
<meta property="twitter:title" content="Job application form - EMC Hospital">
<meta property="twitter:description" content="Make your career with EMC Hospitals. Check the vacancies available and fill the job application form to enhance your career with us.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/career.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/careers.php"/>
 ...
 <div class="container-fluid padding-0 margin-0">
    ...
    <div class="container p-0">
        <ul class="breadcrumb blog_breadcrumb">
            ...
            <li>
                <i class="fa fa-angle-right" aria-hidden="true"></i><a href="careers.php">Careers</a></li>
        </ul>
    </div>
</div>
...
<div class="spec-banner">
    ...
    <img src="assets/web-banners/career.jpg">
   <!--  <div class="container">
        <h1>Careers</h1>
    </div> -->
</div>
    ...
    <div class="contentarea">
        <div class="col-sm-8">
            ...
            <div id="st-accordion" class="st-accordion">
                <ul>
                    <li>
                            <a href="#">Emergency Specialist<span class="st-arrow">Open or Close</span>
                                <p><div>Emergency Specialist<br></div></p>
                            </a>
                            <div class="st-content tabe">
                                <h2>Job Description</h2>
                                <table width="100%" border="0">
                                    <tbody>
                                        <tr>
                                            <td><p>Job Position</p></td>
                                            <td><p>:</p></td>
                                        ...
                                        <tr>
                                            <td><p>Functional Area  </p></td>
                                            <td><p>:</p></td>
                                            <td><p>Emergency Medicine</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Number of Position   </p></td>
                                            <td><p>:</p></td>
                                            <td><p>1</p></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><p>:</p></td>
                                            <td><p>Best in the industry</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Location</p></td>
                                            <td><p>:</p></td>
                                            <td><p><font color="#000000" face="StagSans-Light"><span style="white-space: pre-wrap;"><b>Amritsar , Punjab 143001</b></span></font><br></p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Qualification</p></td>
                                            <td><p>:</p></td>
                                            <td><p>MEM/MD/DNB/MRCEM</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Experience   </p></td>
                                            <td><p>:</p></td>
                                            <td><p>0 to 3 years of experience</p></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><p>Key Skills</p></td>
                                            <td><p>:</p></td>
                                            <td><p>.</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Reporting to</p></td>
                                            <td><p>:</p></td>
                                            <td><p>HOD</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Contact</p></td>
                                            <td><p>:</p></td>
                                            <td><p>emcvacancy@gmail.com                                                </p></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                                ...
                                                <li>
                            <a href="#">Billing Executive<span class="st-arrow">Open or Close</span>
                                ...
                                <table width="100%" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><p>Functional Area  </p></td>
                                            <td><p>:</p></td>
                                            <td><p>Hospital IP Billing and Corporate Billing</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Number of Position   </p></td>
                                            <td><p>:</p></td>
                                        ...
                                        <tr>
                                            <td><p>Location</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Amritsar , Punjab, 143001</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Qualification</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Any Graduation</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Experience   </p></td>
                                            <td><p>:</p></td>
                                            <td><p>3 to 6 yrs Hospital experience</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Job Description</p></td>
                                            <td><p>:</p></td>
                                            <td><p>This role incumbent is responsible for taking care of Handling cash, cheque / draft collection, preparation of IP final bills and OP Bills.</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Key Skills</p></td>
                                            <td><p>:</p></td>
                                            <td><p>IP Billing, Insurance, Finance Counselling</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Reporting to</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Billing Manager</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Contact</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Priyanka@emchospital.com                                                </p></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                                ...
                                                <li>
                            <a href="#">Staff Nurse / Senior Staff Nurse<span class="st-arrow">Open or Close</span>
                                <p>1-5 years (ICU and wards)</p>
                            </a>
                            <div class="st-content tabe">
                                <h2>Job Description</h2>
                                <table width="100%" border="0">
                                    <tbody>
                                        <tr>
                                            <td><p>Job Position</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Staff Nurse / Senior Staff Nurse</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Ref. Code</p>    </td>
                                            <td><p>:</p></td>
                                            <td><p>Clinical Services</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Functional Area  </p></td>
                                            <td><p>:</p></td>
                                        ...
                                        <tr>
                                            <td><p>Qualification</p></td>
                                            <td><p>:</p></td>
                                            <td><p>GNM / Bsc. Nursing with KNC</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Experience   </p></td>
                                            <td><p>:</p></td>
                                            <td><p>1 to 5 years</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Job Description</p></td>
                                            <td><p>:</p></td>
                                            <td><p>This position is responsible for providing nursing care to Outpatients and Inpatients, provide hands-on care by administering medication, managing intravenous lines, observing and monitoring patients' conditions, maintaining records and communicating with doctors. A detailed job description will be handed over on the day of joining.</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Key Skills</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Dialysis, Neuro – ICU / MICU/ SICU, CCU, Cath Lab, Transplant ICU and Ward management.</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Reporting to</p></td>
                                            <td><p>:</p></td>
                                            <td><p>Nursing Officer / Nursing Manager / CNO</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>Contact</p></td>
                                            <td><p>:</p></td>
                                            <td><p>hr.emc@dmhealthcare.com   </p></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <div class="col-sm-4 pull-right">
            <form id="career_form" class="form-horizontal" method="post" enctype="multipart/form-data" action="#">
                <fieldset>
                    <div class="form-group">
                        <div class="col-sm-12 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input  name="full_name" placeholder="Name" class="form-control" id="pe1" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="email"  placeholder="E-Mail Address" class="form-control" id="pe2" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="phone" placeholder="phone" class="form-control" id="pe3" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="position" placeholder="Position" class="form-control" id="pe4" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 inputGroupContainer">
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" placeholder="choose" name="resume" id="resume" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 inputGroupContainer">
                            <p id="error1" class="error" style="display:none">Please fill all the fields to continue</p>
                            <p id="success" class="success" style="display:none">Successfully form is applied</p>
                            <div class="buttonn btn">
                            <input type="submit" id="apply-btn" value="Apply"> <span class="fa fa-send"></span>
                            </div>
                        </div>
                    </div>
                </fieldset>
