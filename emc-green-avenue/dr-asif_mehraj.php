   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Asif Mehraj</a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         <div class="doctor-img">
            <img class="img-fluid" alt="User Image" src="doctors/dr-asif-mehraj.jpg">
         </div>
      ...
      <div class="table-responsive">
         <table border="1" width="100%" class="table-doc">
            <tr>
               <td colspan="2">
                  <h3 class="doctor-hding">Dr. Asif Mehraj</h3>
               </td>
            </tr>
            <tr>
               ...
               <td>
                  <p>MBBS , MS (Gen Surgery), FCRS ( COLORECTALSURGERY), FACRSI</p>
               </td>
            </tr>
         ...
         <table border="1" width="100%" class="table-doc">
            ...
            <tr>
               <td>
                  <div class="cnt-doctorss">
                     <ul>
						<li>Advanced Colorectal Surgery, University Hospital Birmingham, England.</li>
						<li>Fellowship in Pelvic Floor Disorders and Biofeedback, Mumbai.</li>
						<li>Critical Care </li>
					</ul>
                     <div>
               </td>
            ...
            <div class="cnt-doctorss">
            <ul>
					<li>Task force member Global Surgery group for surgical research in India.</li>
					<li>Best paper award at 2nd and 3rd International Colorectal Symposium 2018 & 2019 at Chennai.</li>
					<li>Best scientific research award at ASICON 2018.</li>
					<li>Abbot award of excellence at ACRSICON 2017.</li>
					<li>Best State Chapter award at JAKASICON 2014.</li>
            ...
            <div class="cnt-doctorss">
            <ul>
					<li>26 Publications in peer reviewed indexed journals.</li>
					<li>6 book Chapters.</li>
					<li>22 paper Presentations at National and International Conferences.</li>
					<li>Collaborator for 10 multicentre International Studies (Both Completed & Ongoing).</li>
				</ul>
            </div>
            </td>
            </tr>
           ...
           <ul>
					...
					<li>Benign colorectal disorders including Perianal Fistula, Haemorrhidal, Fissures, Pilonidal sinus, etc.</li>
