...
<html lang="en">
   <head>
      ...
      <!-- Primary Meta Tags -->
      <title>Department of Medicine & Endocrinology | EMC Hospital</title>
      <meta name="title" content="Department of Medicine & Endocrinology | EMC Hospital">
      <meta name="description" content="EMC hospital has the medicine and endocrinology department with the most proficient team of general physicians.">
      <!-- Open Graph / Facebook -->
      <meta property="og:type" content="website">
      <meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/general-medicine.php">
      <meta property="og:title" content="Department of Medicine & Endocrinology | EMC Hospital">
      <meta property="og:description" content="EMC hospital has the medicine and endocrinology department with the most proficient team of general physicians.">
      <meta property="og:image" content="">
      <!-- Twitter -->
      <meta property="twitter:card" content="summary_large_image">
      <meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/general-medicine.php">
      <meta property="twitter:title" content="Department of Medicine & Endocrinology | EMC Hospital">
      <meta property="twitter:description" content="EMC hospital has the medicine and endocrinology department with the most proficient team of general physicians.">
      <meta property="twitter:image" content="">
      <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/general-medicine.php"/>
      <!-- Google Tag Manager -->
   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  <li><a href="#">Home</a></li>
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="general-medicine.php">Department of Medcine & Endocrinology</a></li>
               </ul>
            </div>
         </div>
      </div>
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/internal-family-medicine.jpg">
         <!--    <div class="container">
            <h1>Department of Medcine & Endocrinology</h1>
      ...
      <div class="container">
         <div class="row padding-35 m-0" style="margin:0;">
            ...
            <br>
               ...
               <div class="overview" id="about_doclistingpage" >
                  <p>General Medicine is the field of medicine that deals with the non-surgical treatments and the diagnosis of diseases that affect the internal organs of the patient. </p>
                  <p>The doctors who are trained in this specialisation field are known as general physicians and all the diseases related to the heart, brain, lungs, and other organs are treated by them. Patients usually prefer general physicians when the actual cause of illness is not clear. </p>
                  <p>EMC group of hospitals have the most proficient team of general physicians who are expert in diagnosing and prescribing the best treatment procedure.</p>
                  <p>Under the supervision of <strong> Dr. Harsharan Kaur </strong>along with <strong>Dr. Amarnath,</strong> the department of general medicine is successfully helping patients to have the fastest recovery and lead a healthy lifestyle.</p>
                  <div class="row department-of">
                        ...
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/communicable-disease.png" alt="">
                              </div>
                              <h4 style="color: #ec2589;">Communicable Disease</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/diabetes-hypoglycemia.png" alt="">
                              </div>
                              <h4 style="color: #e2c162;">Diabetes Hypoglycemia</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/diabetes.png" alt="">
                              </div>
                              <h4 style="color: #223c78;">Diabetes</h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/gonadal-menstrual-disorder.png" alt="">
                              </div>
                              <h4 style="color: #d94d60;">Gonadal Menstrual Disorder
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/hypertension.png" alt="">
                              </div>
                              <h4 style="color: #c73727;">Hypertension
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/influenza.png" alt="">
                              </div>
                              <h4 style="color: #313c42;">Influenza
                              </h4>
                           </div>
                        </a>
                     </div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/lipid-disorder.png" alt="">
                              </div>
                              <h4 style="color: #1abcaf;">Lipid Disorder
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/metabolic-bone-calcium.png" alt="">
                              </div>
                              <h4 style="color: #ed462d;">Metabolic Bone Calcium
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/parathyroid-disorder.png" alt="">
                              </div>
                              <h4 style="color: #be1e52;">Parathyroid Disorder
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/rheumatic-fever.png" alt="">
                              </div>
                              <h4 style="color: #a8cf38;">Rheumatic Fever
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/general-medicine/thyroid-disorder.png" alt="">
                              </div>
                              <h4 style="color: #07b6a8;">Thyroid Disorder
                              </h4>
                           </div>
                        </a>
                     </div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     <input id="discipline" name="department" type="hidden" value="Medicine & Endocrinology">
                     <div class="form-row">
         ...
         <!--                         <div class="row">
            ...
            <div class="doc-video-img"><img data-toggle="modal" onclick="playVids0();" data-target="#myModal0" src="assets/images/01.jpg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Medicine & Endocrinology" required="">
