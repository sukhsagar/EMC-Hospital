...
<html lang="en">
   <head>
      ...
      <!-- Primary Meta Tags -->
      <title>Super Specialist Team of Urology in Amritsar | EMC Hospital</title>
      <meta name="title" content="Super Specialist Team of Urology in Amritsar | EMC Hospital">
      <meta name="description" content="EMC group of hospitals has the super-specialist team of Urology in Amritsar. Consult with your best urologist to cure any urinary system related problem.">
      <!-- Open Graph / Facebook -->
      <meta property="og:type" content="website">
      <meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/urology.php">
      <meta property="og:title" content="Super Specialist Team of Urology in Amritsar | EMC Hospital">
      <meta property="og:description" content="EMC group of hospitals has the super-specialist team of Urology in Amritsar. Consult with your best urologist to cure any urinary system related problem.">
      <meta property="og:image" content="">
      <!-- Twitter -->
      <meta property="twitter:card" content="summary_large_image">
      <meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/urology.php">
      <meta property="twitter:title" content="Super Specialist Team of Urology in Amritsar | EMC Hospital">
      <meta property="twitter:description" content="EMC group of hospitals has the super-specialist team of Urology in Amritsar. Consult with your best urologist to cure any urinary system related problem.">
      <meta property="twitter:image" content="">
      <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/urology.php"/>
   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  <li><a href="urology.php">Home</a></li>
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Department of Urology </a></li>
               </ul>
            </div>
         </div>
      </div>
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/urology.jpg">    <!-- <div class="container">        <h1>Department of Urology  </h1>    </div> -->
      </div>
      <div class="container">
         <div class="row padding-35 m-0" style="margin:0;">
            ...
            <style type="text/css">
               ...
               <div class="overview" id="about_doclistingpage">
                  <p>Urology is the branch of medical science that deals with the diagnosis and treatments related to the urinary system in females and the genitourinary system(urinary plus genital organs) in males.</p>
                  <p>The human urinary system consists of kidneys, ureters, gallbladder, urethra, and sphincter muscles. The male urinary system includes the penis, prostate gland, and scrotum.EMC group of hospitals has the most proficient team of doctors who are highly experienced in this field of urology. Consult with our best urologists to cure any urinary system related problem.</p>
                  <div class="row department-of">
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/urology/bladder-cancer.png" alt="">                        </div>
                              <h4 style="color: #f48e8f;">Bladder Cancer</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/urology/bladder-surgery.png" alt="">                        </div>
                              <h4 style="color: #b45b27;">Bladder Surgery</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/urology/kidney-stones.png" alt="">                        </div>
                              <h4 style="color: #34479d;">Kidney Stones</h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/urology/prostate-surgery.png" alt="">                        </div>
                              <h4 style="color: #547ba9;">Prostate Surgery                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/urology/urinary-incontinence.png" alt="">                        </div>
                              <h4 style="color: #df2b26;">
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/urology/urinary-tract-infection.png" alt="">                        </div>
                              <h4 style="color: #4a70b7;">Urinary Tract Infection                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     <iframe width="560" height="315" src="https://www.youtube.com/embed/4lvf0JCkWc0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     <br>            
                  </div>
               </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     <input id="discipline" name="department" type="hidden" value="Urology">							  
                     <div class="form-row">
          ...
          <!-- </div> --><!-- /.col-lg-4 -->
            ...
            <!-- <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="doc_image_doctorlist">
                  <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-vikas-rampal.jpg">                                <a href="#" target="_blank">                    <button>Book an Appointment</button>                </a>                
                  <h1>Dr. Vikas Rampal</h1>
                  <p class="doctor_degree">MBBS , MS , MCHS (Urology)</p>
               ...
               <div class="modal-body">
                  ...
                  <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-6 col-xs-12">            <label for="">Department</label>            <input type="text" class="form-control" id="departments" name="department" value="Urology" required="">            </div>
                     </div>
                     <div class="form-row">
