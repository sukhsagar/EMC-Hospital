...
<div class="container-fluid bread">
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="blood-bank.php">Blood Bank</a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="facilities-banner/facilities-01.jpg">
  <!--   <div class="container">
        <h1>Blood Bank</h1>
    </div> -->
</div>
                 ...
                 <div class="item-holder">
                    <a>
                        <div class="item-holder">
                            ...
                            <img src="internal-external/ambulance.jpg"
                                class="img-responsive">
                            <h4>Ambulance</h4>
