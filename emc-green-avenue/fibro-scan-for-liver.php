...
<head>
  ...
  <title>Fibro Scan for Liver</title>
...
<body>
  ...
  <?php include "include/header.php"; ?>
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="fibro-scan-for-liver.php">Fibro Scan for Liver</a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="facilities-banner/facilities-03.jpg">
    <!-- <div class="container">
        <h1>Fibro Scan for Liver</h1>
    </div> -->
</div>
...
<p>EMC hospitals have been well-equipped to provide the facility of fibro scan for the liver. Fibro scan refers to an ultrasound machine specialized to detect the problems prevailing in the liver. </p> 

<p>It is a non-invasive treatment which evaluates stiffness using a transducer. It is useful in assessing fatty change and scarring in the liver. </p>

<h4>Benefits of Fibroscan are:</h4>

<ul>
<li>It is a painless and quick process.</li>
<li>The need for biopsy reduces.</li>
<li>It is a risk-free process.</li>
<li>It is a proper diagnosis treatment.</li>
<li>It can evaluate any change in the liver.</li>

</ul>

<p>Knowing that FibroScan is the best native solution for detecting any liver disease, the EMC group of hospitals are providing this facility to every and any patient. </p>

<p>We provide timely reports with detailed information to the respective patient. EMC group of hospitals are well accommodated to offer this medical facility 24x7 so that no delays can lead to significant damages.</p>

</div>
</div>
        <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
            <div class="doc_image_doctorlist">
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/fibro-scan-for-liver.jpg">
