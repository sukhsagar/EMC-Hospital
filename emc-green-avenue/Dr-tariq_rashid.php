   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Tariq Rashid Shah</a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         <div class="doctor-img">
         	<img class="img-fluid" alt="User Image" src="doctors/dr-tariq-rashid-shah.jpg">
         </div>
         <div class="img-dwn-cnt">
		 <h5>EXPERIENCE </h5>
				<p>Currently Consultant Interventional Cardiologist at EMC Group of Hospitals Amritsar. </p>
				<p>Worked as Consultant Interventional Cardiologist GEMS Hospital, Vizag.. </p>
				<p>Worked as Associate Consultant Cardiology SKIMS Srinagar.</p>
				<br>
				<br>
		 <h5>OPD TIMING </h5>
      ...
      <div class="table-responsive">
         <table border="1" width="100%" class="table-doc">
            <tr>
               <td colspan="2">
                  <h3 class="doctor-hding">Dr. Tariq Rashid Shah</h3>
               </td>
            </tr>
            <tr>
               ...
               <td>
                  <p>MBBS from GMC Srinagar, MD Internal Medicine from SKIMS Srinagar , DM Cardiology from SKIMS Srinagar.</p>
               </td>
            </tr>
           <tr>
               <td class="doc-details-inr">
               ...
               <td>
                  <p>Gold Medal - IAMACON- 2017</p>
				<p>Gold Medal - IHJ AV Gandhi Awards – 2017</p>
               </td>
            </tr>
            ...
            <tr>
               <td>
                  <div class="cnt-doctorss">
                   <p>Dr. Tariq Rashid Shah has over 4 years of experience in the field of Cardiology.  His area of special interest includes Coronary Intervention, Device Closure of Heart Defects and Management of Heart failure. He has worked in SKIMS Srinagar and GEMS Hospital Vizag.  </p>
                  </div>
               </td>
            </tr>
             ...
             <tr>
               <td>
                  <div class="cnt-doctorss">
				<ul>
					<li>Coronary Intervention- Bifurcation & Complex.</li>
					<li>Device Closure of Heart defects- ASD/VSD/PDA</li>
					<li>Device Intervention in Heart Failure.</li>
