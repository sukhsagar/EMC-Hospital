...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Hospital Image Gallery - EMC Hospital</title>
<meta name="title" content="Hospital Image Gallery - EMC Hospital">
<meta name="description" content="Check our hospital gallery where you can get an idea about our hospital, infrastructure, labs, and other images that may help you to get a clear picture.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/gallery.php">
<meta property="og:title" content="Hospital Image Gallery - EMC Hospital">
<meta property="og:description" content="Check our hospital gallery where you can get an idea about our hospital, infrastructure, labs, and other images that may help you to get a clear picture.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/gallery.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/gallery.php">
<meta property="twitter:title" content="Hospital Image Gallery - EMC Hospital">
<meta property="twitter:description" content="Check our hospital gallery where you can get an idea about our hospital, infrastructure, labs, and other images that may help you to get a clear picture.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/gallery.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/gallery.php"/>
...
<!-- End Google Tag Manager (noscript) -->
      ...
      <div class="container-fluid padding-0 margin-0">
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li>
                     <i class="fa fa-angle-right" aria-hidden="true"></i><a href="gallery.php">Gallery</a>
                  </li>
               </ul>
            </div>
         </div>
         <div class="spec-banner">
            ...
            <img src="assets/web-banners/gallery.jpg">
            <!-- <div class="container">
               <h1>Gallery</h1>
               </div> -->
         </div>
         ...
         <div class="section page-content-first">
            <div class="container mt-2">
               <div class="row">
                  ...
                  <!--  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/gaelly-11.jpg" data-fancybox-group="gallery"> <img src="gallery/gaelly-11s.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div> -->
					 <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-1.jpg" data-fancybox-group="gallery"> <img src="gallery/img-1.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					 <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-2.jpg" data-fancybox-group="gallery"> <img src="gallery/img-2.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-3.jpg" data-fancybox-group="gallery"> <img src="gallery/img-3.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-4.jpg" data-fancybox-group="gallery"> <img src="gallery/img-4.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-5.jpg" data-fancybox-group="gallery"> <img src="gallery/img-5.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-6.jpg" data-fancybox-group="gallery"> <img src="gallery/img-6.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-7.jpg" data-fancybox-group="gallery"> <img src="gallery/img-7.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-8.jpg" data-fancybox-group="gallery"> <img src="gallery/img-8.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-9.jpg" data-fancybox-group="gallery"> <img src="gallery/img-9.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-10.jpg" data-fancybox-group="gallery"> <img src="gallery/img-10.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-11.jpg" data-fancybox-group="gallery"> <img src="gallery/img-11.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-12.jpg" data-fancybox-group="gallery"> <img src="gallery/img-12.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
					  <div class="col-md-4 img-gallery"><a class="fancybox" href="gallery/img-13.jpg" data-fancybox-group="gallery"> <img src="gallery/img-13.jpg"
                     class="img-responsive" border="0" alt=""> </a> </div>
