...
<div class="container-fluid bread">
    <div class="container p-0">
        <ul class="breadcrumb blog_breadcrumb">
            ...
            <li>
                <i class="fa fa-angle-right" aria-hidden="true"></i><a href="payment-failed.php">
            Payment Error</a></li>
        </ul>
    </div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 text-center">
			<div class="payment-cstm">
                <i class="fa fa-times-circle" aria-hidden="true" style="color: #ff3100;"></i>
                <p class="text-center" style="color: #3e3d3d;">Error during transaction</p>
			</div>
		</div>
	</div>
</div>
