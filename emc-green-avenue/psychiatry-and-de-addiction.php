...
<head>
  ...
  <title> Psychiatry and De addiction</title>
...
<div class="container-fluid padding-0 margin-0">
    ...
    <div class="container p-0">
        <ul class="breadcrumb blog_breadcrumb">
            ...
            <li>
                <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="psychiatry-and-de-addiction.php">Psychiatry and De addiction</a></li>
        </ul>
    </div>
</div>
...
<div class="spec-banner">
    ...
    <img src="assets/web-banners/cardiology.png">
    <div class="container">
        <h1>Psychiatry and De addiction</h1>
    </div>
</div>
...
<p>EMC Hospital Psychiatry department is the branch of medicine focused on the diagnosis, treatment, and prevention of mental, emotional and behavioural disorders.</p>

<p>Lungs play a very crucial role in the respiratory system of our body as they deliver oxygen into the bloodstream and remove carbon dioxide. While you breathe in, the air passes through the throat into the trachea(windpipe). The windpipe proceeds into left and right tubes, known as  </p>



<p>A psychiatrist is a medical doctor (an M.D. or D.O.) who has the experience and specialises in mental health, including substance use disorders. Psychiatrists are qualified to assess both the mental and physical aspects of psychology.
</p>  


<p>Also, patients not knowing the exact cause of the problem or suffering from any mental health issue can consult our proficient doctor, Dr. Monikeerthana, from the psychiatrist department. </p>   

<div class="department-of">
<div class="service-list">
<h1>Department of  Psychiatry and De addiction</h1>
<ul class="clearfix">
<li>De-addiction</li>
<li>Depression</li>
<li>Anxiety disorders</li>
<li>Personality disorder</li>
<li>Schizophrenia treatment</li>
<li>Geriatric psychiatry</li>
        ...
        <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
            <div class="doc_image_doctorlist">
                ...
                <p class="doctor_degree">MBBS, M.D ,D.M</p>
            ...
            <div class="doc_image_doctorlist">
                ...
                <p class="doctor_degree">MD,DM Cardiology</p>
                      ...
                      <p>Dr. Vivek Tandon ( Cardiologist) </p>
                       ...
                       <div class=" col-lg-4 col-sm-4 col-md-4 col-xs-12 doctor-videos-text-style vid-section">
                        ...
                        <div class="doc-video-img"><img data-toggle="modal" onclick="playVids0();" data-target="#myModal1" src="assets/images/08.jpg">
                      <p>Dr. Tariq Rashid Shah ( Cardiologist) </p>
                        <div class="youtube-icon">
                        <img data-toggle="modal" onclick="playVids0();" data-target="#myModal1" src="assets/images/you2.png"></div>
                        </div>
                        <!-- The Modal -->
                        <div class="modal" id="myModal1" onclick="pauseVids0()">
                        <div class="modal-dialog">
                        <div class="modal-content">
                        ...
                        <button type="button" class="close blog_video_close" data-dismiss="modal">×</button>
                        <div>
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/GWD1x_yXPsA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
