...
class AMP_DOM_Utils
{
     ...
     * @var string
     */
    const AMP_BIND_DATA_ATTR_PREFIX = \Google\Web_Stories_Dependencies\AmpProject\Dom\Document::AMP_BIND_DATA_ATTR_PREFIX;
    /**
    ...
    {
        \Google\Web_Stories_Dependencies\_deprecated_function(__METHOD__, '1.5.0', 'AmpProject\\Dom\\Document->isValidHeadNode()');
        return \Google\Web_Stories_Dependencies\AmpProject\Dom\Document::fromNode($node)->isValidHeadNode($node);
    }
    /**
    ...
    {
        \Google\Web_Stories_Dependencies\_deprecated_function(__METHOD__, '1.2.1');
        return \Google\Web_Stories_Dependencies\AmpProject\Dom\Document::AMP_BIND_DATA_ATTR_PREFIX;
    }
    /**
    ...
    {
        \Google\Web_Stories_Dependencies\_deprecated_function(__METHOD__, '1.5.0');
        return $html;
    }
    /**
     ...
     */
    public static function get_content_from_dom(\Google\Web_Stories_Dependencies\AmpProject\Dom\Document $dom)
    {
     ...
     */
    public static function get_content_from_dom_node(\Google\Web_Stories_Dependencies\AmpProject\Dom\Document $dom, $node)
    {
        \Google\Web_Stories_Dependencies\_deprecated_function(__METHOD__, '1.5.0', 'AmpProject\\Dom\\Document::saveHtml()');
     ...
     */
    public static function create_node(\Google\Web_Stories_Dependencies\AmpProject\Dom\Document $dom, $tag, $attributes)
    {
    ...
    {
        \Google\Web_Stories_Dependencies\_deprecated_function(__METHOD__, '0.7');
        if (null === $node) {
            $node = $dom->body;
        }
    ...
    {
        return \in_array(\strtolower($tag), \Google\Web_Stories_Dependencies\AmpProject\Tag::SELF_CLOSING_TAGS, \true);
    }
    /**
    ...
    {
        \Google\Web_Stories_Dependencies\_deprecated_function('AMP_DOM_Utils::get_element_id', '1.5.1', 'Use AmpProject\\Amp\\Dom\\Document::getElementId() instead');
        return \Google\Web_Stories_Dependencies\AmpProject\Dom\Document::fromNode($element)->getElementId($element, $prefix);
    }
    /**
