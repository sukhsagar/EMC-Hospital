...
use DOMElement;
use Exception;
final class CannotInlineRuntimeCss implements \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error
{
    use ErrorProperties;
    ...
    public static function fromException(\Exception $exception, \DOMElement $ampRuntimeStyle, $version)
    {
        ...
        return new self(\sprintf(self::EXCEPTION_STRING, $exception, new \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error\ElementDump($ampRuntimeStyle), $version));
    }
    /**
