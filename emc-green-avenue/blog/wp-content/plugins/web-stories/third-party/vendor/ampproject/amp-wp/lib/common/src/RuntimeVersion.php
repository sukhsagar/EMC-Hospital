...
final class RuntimeVersion
{
     ...
     */
    public function __construct(\Google\Web_Stories_Dependencies\AmpProject\RemoteGetRequest $remoteRequest)
    {
    ...
    public function currentVersion($options = [])
    {
        ...
        $version = !empty($options['canary']) ? $metadata->diversions[0] : $metadata->ampRuntimeVersion;
