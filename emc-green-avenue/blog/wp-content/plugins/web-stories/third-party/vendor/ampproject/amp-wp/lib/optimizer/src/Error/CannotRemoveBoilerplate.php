...
final class CannotRemoveBoilerplate implements \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error
{
    ...
    {
        return new self(self::ATTRIBUTES_STRING . new \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error\ElementDump($element));
    }
    /**
     * Instantiate a CannotRemoveBoilerplate object for attributes that require the boilerplate to be around.
     *
    ...
    {
        return new self(self::AMP_AUDIO_STRING . new \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error\ElementDump($element));
    }
    /**
    ...
    {
        return new self(self::UNSUPPORTED_LAYOUT_STRING . new \Google\Web_Stories_Dependencies\AmpProject\Optimizer\Error\ElementDump($element));
    }
    /**
