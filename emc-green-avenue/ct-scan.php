...
<?php include "include/header.php"; ?>
 ...
 <div class="container-fluid bread">
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="ct-scan.php">CT-Scan</a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="facilities-banner/facilities-04.jpg">
  <!--   <div class="container">
        <h1>CT Scan</h1>
    </div> -->
</div>
...
<p>EMC group of hospitals are fully equipped with all the latest technologies, including the CT-scan to provide timely healthcare to patients.</p>

<p> CT-Scan refers to the technology used to derive medical imaging of the head, neck, lungs, legs or any affected area to detect the health issue.  </p>

<p>CT- Scan has proven to provide more detailed images of the body as compared to the standard x-rays as it can visualize every part.</p>
<h4>CT- Scan is useful in diagnosing:</h4>

<ul>
    <li>Bone and muscle disorders like tumours and fractures</li>
 <li>Any infection or blood clot</li>
 <li>Internal bleeding and injuries</li>
 <li>Cancer detection</li>

</ul>

<p>We have the latest X-ray machines that can never generate the wrong results. Under the supervision of lab assistants, report generation is delivered on time so that patients can start with the treatment process.</p>

<p>You can avail of this medical facility 24x7 at EMC hospitals and immediately continue with your treatment process.</p>
        ...
        <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
            <div class="doc_image_doctorlist">
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/ct-scan.jpg">
