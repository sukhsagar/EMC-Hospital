...
<?php include "include/header.php"; ?>
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="eeg-emg-ecg.php">EEG/EMG/ECG</a></li>
 ...
 <div class="spec-banner">
    <div class="banner-gredient"></div>
     <img src="facilities-banner/facilities-07.jpg">
   <!--  <div class="container">
        <h1>EEG/EMG/ECG</h1>
    </div> -->
</div>
...
<p>EMC group of hospitals work seamlessly to provide the best healthcare with the top quality medical facilities and technologies. We have the latest and well-equipped machines for performing EEG, EMG, and ECG.</p>
<p>EEG is performed for assessing the electrical activity of the brain. EEG is a quick, easy and painless process that takes an hour to complete.</p>
<p>ECG for measuring the heart’s electrical activity. The process is risk and pain-free. Only the machine records ECG, and no electricity is transferred into the body.
 
 </p>

<p>EMG is a test performed for evaluation of muscle and nerve function. The process is considered a little bit uncomfortable as compared to the other two. EMG is done with NCV(Nerve conduction velocity test).</p>

<p>All the three above symptomatic treatments are reliable, but do consult the physician before opting for any of the processes. EMC group of hospitals being a responsible medical facility recommends the best diagnostic techniques and treatments to every and any patient. </p>

<p>Our expert team of doctors and staff are available 24x7 to facilitate the patients with timely medical reports and guidelines for continuing the treatment process. We make sure that no patient suffers because of delayed diagnosis or treatment.</p>
</div>
</div>
        <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
            <div class="doc_image_doctorlist">
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/eeg.jpg">
