    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo $action; ?>" method="post" name="donationForm">
          ...
          <input name="surl" type="hidden" value="<?php echo (empty($posted['surl'])) ? 'http://emchospital.co.in/emc/emc-green-avenue/payment-success.php' : $posted['surl'] ?>" size="64" />
          <input name="furl" type="hidden" value="<?php echo (empty($posted['furl'])) ? 'http://emchospital.co.in/emc/emc-green-avenue/payment-failed.php' : $posted['furl'] ?>" size="64" />
        ...
        <div class="inner-form row ">
            ...
            <div class="col-sm-12 col-md-4">
                <div class="form-group ">
                    <input type="date" class="form-control" placeholder="Date and time" name="date" id="datetime" required>
                </div>
            </div>
            <!--close col-first-->
            <div class="col-sm-12 col-md-4">
        ...
        <div class="row">
             <form method="POST" action="" >
                ...
                <div class="inner-form row ">
                  ...
                  <div class="col-sm-12 col-md-4">
                    <div class="form-group ">
                      <input type="date" class="form-control date" data-provide="datepicker" placeholder="Date and time" name="date"  id="datetime" required>
                    </div>
                  </div>
                  <!--close col-first-->
                  <div class="col-sm-12 col-md-4">
...
{  
   ...
   {var optionArray = ["|Select Hospital","EMC Hospital Green Avenue ,Amritsar|EMC Hospital Green Avenue,Amritsar"," EMC Hospital  Shakti Nagar,Amritsar"];
   }
                    ...
                    <div class="container">
                        <div class="row grid-new">
                                ...
                                <ul class="emc-top-number hidden-xs hidden-sm">
                                  <li><a class="nav-emc-link" href="#">
                                    ...
                                    <span class="d-none d-md-block">
                                        <small>Ambulance</small><br> 62395-11500
                                    </span>
                                </div></a>
                              </li>
                                  <li><a class="nav-emc-link" href="#">
                                    <div class="hospital">
                                    <span class="d-none d-md-block">
                                        <small>Hospital</small><br> 70091-82189
                                    </span>
                                </div></a>
                              </li>
                               <li><a class="nav-emc-link" href="#">
                                    ...
                                    <span class="d-none d-md-block">
                                        <small>Email</small><br> emchelpline@gmail.com
                                    </span>
                                </div></a>
                              </li>
                            ...
                            <a href="#">
                             ...
                             <li><a class="brochure" href="#"><i class="fa appwhats  fa-whatsapp"></i>  </a></li>
