...
<html lang="en">
   <head>
      ...
      <!-- Primary Meta Tags -->            
      <title>Best Orthopedic Hospital in Amritsar - EMC Hospital</title>
      <meta name="title" content="Best Orthopedic Hospital in Amritsar - EMC Hospital">
      <meta name="description" content="EMC hospital is one of the most reputed orthopaedic hospital and knee replacement centre in Amritsar. Book your appointment now.">
      <!-- Open Graph / Facebook -->            
      <meta property="og:type" content="website">
      <meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/ortho-joint-replacement-surgeon.php">
      <meta property="og:title" content="Best Orthopedic Hospital in Amritsar - EMC Hospital">
      <meta property="og:description" content="EMC hospital is one of the most reputed orthopaedic hospital and knee replacement centre in Amritsar. Book your appointment now.">
      <meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/orthopedic-advance-joint replacement.jpg">
      <!-- Twitter -->            
      <meta property="twitter:card" content="summary_large_image">
      <meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/ortho-joint-replacement-surgeon.php">
      <meta property="twitter:title" content="Best Orthopedic Hospital in Amritsar - EMC Hospital">
      <meta property="twitter:description" content="EMC hospital is one of the most reputed orthopaedic hospital and knee replacement centre in Amritsar. Book your appointment now.">
      <meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/orthopedic-advance-joint replacement.jpg">
      <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/ortho-joint-replacement-surgeon.php"/>
   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  <li><a href="#">Home</a></li>
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="ortho-joint-replacement-surgeon.php">Department of  Orthopaedics & Joint Replacement  </a></li>
               </ul>
            </div>
         </div>
      </div>
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/orthopedic-advance-joint replacement.jpg">         <!--  <div class="container">            <h1>Department of  Orthopaedics & Joint Replacement </h1>                        </div> -->            
      </div>
      <div class="container">
         <div class="row padding-35 m-0" style="margin:0;">
            <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
               ...
               <!--  <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/dr-guriqbal-singh-chhina.jpg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Guriqbal Singh Chhina" data-speciality="Joint Replacement Surgeon" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
           ...
           <br>
               ...
               <div class="overview" id="about_doclistingpage">
                  <h1><b>Knee Replacement in Amritsar</b></h1>
                  <br>                                    
                  <p>The Department of Orthopedics at EMC Hospital deals with the diagnosis and treatment of knees, joints, hips, bones, and muscles. Our highly trained and skilled orthopedic surgeons perform surgical procedures with full efficiency and expertise.                  The patients can consult with orthopedic surgeons, sports doctors, rheumatologists, and general practitioners to eliminate orthopedic problems.                  </p>
                  <h4>Some common orthopedic problems that can be easily treated at our proficient medical center are:-</h4>
                  <ul>
                     <li>Torn or inflamed muscles, tendons, and cartilage.</li>
                     <li>Fractured bones.</li>
                     <li>Severe osteoarthritis of the hip or knee.</li>
                     <li>Dislocations of joints.</li>
                     <li>Trapped nerves.</li>
                     <li>Infections in bones and joints.</li>
                     <li>Spine Disorders</li>
                  </ul>
                  <p>The orthopedic surgeons usually recommend the replacement of those joints with artificial ones that have been destroyed by any disease or are worn out. These kinds of <b>knee and joint replacement</b> surgeries relieve pain and provide the patient a healthier life.                  </p>
                  <p>Also, our specialists can assess the damage around the fracture and then prescribe the best possible treatment procedure that will mend the affected area. There are cases where surgical treatments are not required depending on the medical condition of the patient. For such assistance, our medical center has highly qualified and experienced  surgeons to provide a limitless life to the patient.                  </p>
                  <p>With years of experience in orthopedics, <b>Dr. AJAY ABROL & DR. AMITHASH</b> brings the best results to patients and helps them have a speedy recovery.                   </p>
                  <div class="row department-of">
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/accident-trauma.png" alt="">                              </div>
                              <h4 style="color: #3d4b20;">Accident Trauma</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/arthroscopy-machine.png" alt="">                              </div>
                              <h4 style="color: #2cb7e6;">Arthroscopy Machine</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/congenital-deformities.png" alt="">                              </div>
                              <h4 style="color: #c0d72f;">Congenital Deformities</h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/elbow-shoulder-joint-replacement.png" alt="">                              </div>
                              <h4 style="color: #2384c6;">Elbow Shoulder Joint replacement                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/joint-replacement.png" alt="">                              </div>
                              <h4 style="color: #e8a721;">Joint Replacement   (With Minimum Inuasive Techniuqe)                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/ligament-repair-sports-injuries.png" alt="">                              </div>
                              <h4 style="color: #ed1f24;">Ligament Repair Sports Injuries                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                                 <img src="icons-scope/ortho-joint/non-union-fractures.png" alt="">                              </div>
                              <h4 style="color: #3e63ae;">Non Union Fractures                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     <input id="discipline" name="department" type="hidden" value="Orthopaedics & Joint Replacement">                                          
                     <div class="form-row">
         ...
         <div class="row">
            <div class="col-md-12 col-lg-12">
               ...
               <iframe width="560" height="315" src="https://www.youtube.com/embed/z74imj6e3dA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     ...
                     <div class=" col-lg-4 col-sm-4 col-md-4 col-xs-12 doctor-videos-text-style vid-section">
                        <div class="doctor-dot-img">
                           <div class="doc-video-img">
                              <img data-toggle="modal" onclick="playVids0();" data-target="#myModal0" src="assets/images/05.jpg">                                                            
                              <p>M.S (Ortho Sr.Joint Replacement Surgeon)</p>
                              <div class="youtube-icon">                                 <img data-toggle="modal" onclick="playVids0();" data-target="#myModal0" src="assets/images/you2.png">                              </div>
                           </div>
                              ...
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                       ...
                                       <div>
                                          <iframe width="100%"  height="315" src="https://www.youtube.com/embed/mGTlc84x7JY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                                          <!-- <iframe width="100%" id="yutube-vid0" height="315" src="https://www.youtube.com/embed/l09p6b-QCEk?enablejsapi=1&amp;origin=https%3A%2F%2Fwww.asterbangalore.com" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" data-gtm-yt-inspected-8433319_44="true"></iframe> -->                                                                              
                                     <!--  </div>
                                    </div>
                                 </div>
                              </div>
      ...
      <section class="advance-tecnology">
        ...
        <!-- <div id="myModal" class="modal fade" role="dialog">
                  ...
                  <div class="modal-body">
                     ...
                     <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-6 col-xs-12">            <label for="">Department</label>            <input type="text" class="form-control" id="departments" name="department" value="Orthopaedics & Joint Replacement" required="">            </div>
                        </div>
                        <div class="form-row">
         ...
         <script>    $(document).ready(function(){          $('#myModal').modal('show');    }); </script><!----------------------modal-end---------------------->      
      </section>
      </div>            
