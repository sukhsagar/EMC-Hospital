...
<html lang="en">
   <head>
      ...
      <title>Department of Oral & Maxillofacial Surgery</title>
   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="oral-and-maxillofacial-surgery.php">Department of Oral & Maxillofacial Surgery </a></li>
               </ul>
            </div>
         </div>
      </div>
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/oral-and-maxillofacial-surgery.jpg"> <!--    <div class="container">        <h1>Department of Oral & Maxillofacial Surgery </h1>    </div> -->
      </div>
      <div class="container">
         <div class="row padding-35 m-0" style="margin:0;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="doc-cardx">
                            ...
                            <div class="doc_image_doctorlist">
                               <img class="img-responsive" width="100%" src="doctors/dr-ms-dewaan.jpg">
                               <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.M.S.Dewaan" data-speciality="" data-hospital="Hospital EMC" href="#" target="_blank">
            ...
            <style type="text/css">
               ...
               <div class="overview" id="about_doclistingpage">
                  <p>Plastic surgeries deal with a vast range of surgical treatments that are performed to repair, reconstruct and replace various parts in the body, which include face, hands, breast, stomach, head, and skin. Patients may often think there is a use of plastic surgery in accordance with the name, but that is not true. </p>
                  <p>Reconstructive surgeries are performed on various parts of the body that were affected due to any congenital disability, disease or accident. The procedure includes palate repair, scar revision, cleft lip, or reconstruction of burns. </p>
                  <p>Some surgical treatments are performed to improve the body functionality and some to change the appearance of any body part as per the patient’s request.</p>
                  <div class="row department-of">
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/craniomaxillofacial-surgeries.png" alt="">                        </div>
                              <h4 style="color: #3fbb8b;">Craniomaxillofacial Surgeries</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/facial-bone-fractures.png" alt="">                        </div>
                              <h4 style="color: #ec1a23;">Facial Bone Fractures</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/jaw-joint-disorder-management.png" alt="">                        </div>
                              <h4 style="color: #414042;">Jaw Joint Disorder Management</h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/microsurgery-services.png" alt="">                        </div>
                              <h4 style="color: #220e1d;">Microsurgery services                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/oral-cavity-cancer.png" alt="">                        </div>
                              <h4 style="color: #3b4652;">Oral Cavity Cancer                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/orthognatic-surgery.png" alt="">                        </div>
                              <h4 style="color: #eb8137;">Orthognatic Surgery                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/oral-maxillofacial/repair-of-congenital-clefts.png" alt="">                        </div>
                              <h4 style="color: #f79521;">Repair of Congenital Clefts                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     <input id="discipline" name="department" type="hidden" value="Oral & Maxillofacial Surgery">                     
                     <div class="form-row">
          ...
          <!-- </div> --><!-- /.col-lg-4 -->
            ...
            <!-- <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="doc_image_doctorlist">
                  <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-ms-dewaan.jpg">                                <a href="#" target="_blank">                    <button>Book an appointment</button>                </a>                
                  <h1>Dr. M.S. Dewaan</h1>
                  <p class="doctor_degree">MBBS , MS , M.CH. (Neuro Surgeon)</p>
               </div>
            </div> -->
         </div>
         <!-- <div class="row">        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">           <div class="doc_image_doctorlist">                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-ms-dewaan.jpg">                                <a href="#" target="_blank">                    <button>Book an appointment</button>                </a>                <h1>Dr. M.S. Dewaan</h1>                <p class="doctor_degree">MBBS , MS , M.CH. (Neuro Surgeon)</p>                                        </div>        </div>      </div> -->    
      </div>
               ...
               <div class="modal-body">
                  ...
                  <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-6 col-xs-12">            <label for="">Department</label>            <input type="text" class="form-control" id="departments" name="department" value="Oral & Maxillofacial Surgery" required="">            </div>
                     </div>
                     <div class="form-row">
