   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Ishita Sharma</a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         <div class="doctor-img">
            <img class="img-fluid" alt="User Image" src="doctors/dr-ishita-sharma.jpg">
         </div>
         <div class="img-dwn-cnt">
		 <h5>EXPERIENCE</h5>
		 <p>6 years+  achievements - national award for research on high risk neonates</p>
		 <br>
		 <br>
           <h5>OPD TIMING </h5>
				<p>EMC Super Speciality Hospital, Green Avenue, Amritsar </p>
				<p>Mon  to   Sat 	:  Timing :   10:00 AM   to    2:00 PM </p>
				<p><b>Swift Hospital, Majitha Road,  Amritsar </b></p>
				<p>Mon  to   Sat 	:   Timing :  04:00 PM   to    6:00 PM  </p>
         </div>
      </div>
      ...
      <div class="table-responsive">
         <table border="1" width="100%" class="table-doc">
            <tr>
               <td colspan="2">
                  <h3 class="doctor-hding">Dr. Ishita Sharma</h3>
               </td>
            </tr>
            <tr>
               ...
               <td>
                  <p>MBBS , DNB obstetrics and Gynaecology, MRCOG , Fellowship in test tube baby</p>
               </td>
            </tr>
      ...
      <div class="table-responsive">
         <table border="1" width="100%" class="table-doc">
            ...
            <div class="cnt-doctorss">
           <ul>
					<li>Have published 5 researches in International journals</li>
				</ul>
            </div>
            </td>
            </tr>
