...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Dr. Monikeerthana | Psychiatrist - EMC Hospital</title>
<meta name="title" content="Dr. Monikeerthana | Psychiatrist - EMC Hospital">
<meta name="description" content="Dr. Monikeerthana having 3 years of experience and currently working in the EMC Group of Hospitals. She is currently pursuing MRCPsych from Edinburgh, UK.">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/dr-monikeerthana.php">
<meta property="og:title" content="Dr. Monikeerthana | Psychiatrist - EMC Hospital">
<meta property="og:description" content="Dr. Monikeerthana having 3 years of experience and currently working in the EMC Group of Hospitals. She is currently pursuing MRCPsych from Edinburgh, UK.">
<meta property="og:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/dr-monikeerthana.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/dr-monikeerthana.php">
<meta property="twitter:title" content="Dr. Monikeerthana | Psychiatrist - EMC Hospital">
<meta property="twitter:description" content="Dr. Monikeerthana having 3 years of experience and currently working in the EMC Group of Hospitals. She is currently pursuing MRCPsych from Edinburgh, UK.">
<meta property="twitter:image" content="https://emchospital.co.in/emc-green-avenue/assets/web-banners/dr-monikeerthana.jpg">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/dr-monikeerthana.php"/>
...
<!-- End Google Tag Manager (noscript) -->
         ...
         <div class="container-fluid bread">
            ...
            <div class="container p-0">
               ...
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Monikeerthana</a></li>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         ...
         <div class="doctor-img">
            ...
            <img class="img-fluid" alt="User Image" src="doctors/dr-monikeerthana.jpg">
		 ...
		 <p>Total Experience is 3 Years </p>

		 <p>Currently Working with EMC Group of Hospitals, Amritsar .</p>
		 ...
		 <h5>OPD TIMING </h5>
				...
				<p>EMC Super Speciality Hospital, Green Avenue, Amritsar </p>

				<p>Mon  to   Sat 	:    10:00 AM   to    2:00 PM  </p>
         ...
         <table border="1" width="100%" class="table-doc">
            ...
            <tr>
               ...
               <td colspan="2">
                  ...
                  <h3 class="doctor-hding">Dr. Monikeerthana</h3>
            ...
            <tr>
               ...
               <td>
                  ...
                  <p>MBBS , DPM , Pursuing MRCPsych ( Edinburgh, UK)</p>
            ...
            <tr>
               ...
               <td>
                  ...
                  <p>Research in Advanced Functional Neuroimaging in Psychiatric disorders and role of receptor.</p>

                  <p>Therapeutic advances in medical Oncology.</p>
            ...
            <tr>
               ...
               <td>
                  ...
                  <div class="cnt-doctorss">
                   ...
                   <p>Skilled in Managing.</p>

				<ul>

					<li>Schizophrenia and related Psychotic disorders.</li>

					<li>Mood Disorders ( Depression, Anxiety Disorders, Bipolar Affective Disorders)</li>

					<li>Personality Disorders ( Borderline Personality disorders, Etc) </li>

					<li>Addiction Disorders, ( Alcohol, Opium, Cannabis, Smoking, Internet Addiction)</li>

					<li>Autism, ADHD, Intellectual Disability </li>

					<li>Delirium and Dementia </li>

					<li>Geriatric Psychiatric Disorders </li>

					<li>Skilled in Psychotherapy , Couple Therapy, Problem solving and Counselling</li>
             ...
             <tr>
               ...
               <td>
                ...
                <ul>
					...
					<li>Certification in cognitive behavioural therapy. </li>

					<li>Certification in positive Psychiatry and Mental Health from the university of Sydney.</li>

					<li>Certification in Alzheimer’s Disease and Dementia Care from Salisbury University.</li>

					<li>Certification  in schizophrenia from Wesleyan University.</li>

					<li>Certification in ACLS, BLS, PALS From AHA.</li>

					<li>Journal Published in the topic of Quality of sleep in Psychiatric Inpatients and Outpatients( Dr. MGR University)   </li>
