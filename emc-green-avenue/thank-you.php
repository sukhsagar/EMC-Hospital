...
<head>
  ...
  <!-- Primary Meta Tags -->
<title>Thank You For Contacting - EMC Hospital</title>
<meta name="title" content="Thank You For Contacting - EMC Hospital">
<meta name="description" content="EMC Hospitals is a Best Multispeciality Hospital in Amritsar. Thanks for contacting us.">
<!-- Google Tag Manager -->
...
<div class="container-fluid bread">
    <div class="container p-0">
        <ul class="breadcrumb blog_breadcrumb">
            ...
            <li>
                <i class="fa fa-angle-right" aria-hidden="true"></i><a href="payment-success.php">
            Thank You</a></li>
        </ul>
    </div>
...
<div class="container">
	<div class="row">
		<div class="col-md-12 col-sm-12 text-center">
			<div class="payment-cstm">
				<i class="fa fa-check-circle" aria-hidden="true"></i>
				<p class="text-center">Thank You! <br/><br/>We will call you shortly.</p>
			</div>
		</div>
	</div>
</div>
...
<section class="main-content" id="tabs">
