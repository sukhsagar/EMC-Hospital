...
<title>Cancer Care Hospital in Amritsar | EMC Hospital</title>

<meta name="title" content="Cancer Care Hospital in Amritsar | EMC Hospital">

<meta name="description" content="EMC Group of Hospitals has the best medical team in the oncology department in Amritsar. Schedule an appointment with a specialist.">
...
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/oncology.php">

<meta property="og:title" content="Cancer Care Hospital in Amritsar | EMC Hospital">

<meta property="og:description" content="EMC Group of Hospitals has the best medical team in the oncology department in Amritsar. Schedule an appointment with a specialist.">
...
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/oncology.php">

<meta property="twitter:title" content="Cancer Care Hospital in Amritsar | EMC Hospital">

<meta property="twitter:description" content="EMC Group of Hospitals has the best medical team in the oncology department in Amritsar. Schedule an appointment with a specialist.">

<meta property="twitter:image" content="">

  

 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/oncology.php"/>
...
<?php include "include/header.php"; ?>
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="oncology.php">Department of Medical & Surgical Oncology </a></li>
 ...
 <div class="spec-banner">
    ...
    <img src="assets/web-banners/medical-oncology-onco-surgery.jpg">

<!--     <div class="container">

        <h1>Department of Medical & Surgical Oncology  </h1>
...
<p>EMC group of hospitals has the best medical oncology (MO) department. The department communicates the results of clinical and experimental research in oncology and hematology, particularly with experimental therapeutics with the help of immunotherapy and chemotherapy. </p>





<p>It also provides state-of-the-art reviews on clinical and experimental therapies in oncology and hematology. Topics covered include immunobiology, pathogenesis, and their treatment. </p> 
    ...
    <br>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/breast-cancer.png" alt="">

                        </div>

                        <h4 style="color: #ed0874;">breast-cancer</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/cancer-of-cervix-uterus-ovaries.png" alt="">

                        </div>

                        <h4 style="color: #6abc5f;">Cancer of Cervix, Uterus Ovaries</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/chemotherapy.png" alt="">

                        </div>

                        <h4 style="color: #6aa9dc;">Chemotherapy</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/head-neck-cancer.png" alt="">

                        </div>

                        <h4 style="color: #2f3f55;">Head Neck Cancer
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/lung-cancer.png" alt="">

                        </div>

                        <h4 style="color: #f15d5d;">Lung Cancer
                ...
                <a href="nephrology.php">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/lymphomas-related-blood-cancers.png" alt="">

                        </div>

                        <h4 style="color: #e92655;">Lymphomas Related Blood Cancers
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/medical-surgical/stomach-intestinal-cancer.png" alt="">

                        </div>

                        <h4 style="color: #35c2f1;">Stomach Intestinal Cancer
       ...
       <div class="clearfix"></div>
        ...
        <div class="form-pages_contact">
                ...
                <input id="discipline" name="department" type="hidden" value="Medical & Surgical Oncology">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Medical & Surgical Oncology" required="">
