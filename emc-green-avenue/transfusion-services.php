...
<html lang="en">
   <head>
      ...
      <!-- Primary Meta Tags -->
<title>24/7 Blood Bank- EMC Group of Hospitals</title>
<meta name="title" content="24/7 Blood Bank- EMC Group of Hospitals">
<meta name="description" content="Licensed Blood bank for each and every blood group, EMC is available for 24 hours to deal best with the emergency cases. ">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/transfusion-services.php">
<meta property="og:title" content="24/7 Blood Bank- EMC Group of Hospitals">
<meta property="og:description" content="Licensed Blood bank for each and every blood group, EMC is available for 24 hours to deal best with the emergency cases. ">
<meta property="og:image" content="">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/transfusion-services.php">
<meta property="twitter:title" content="24/7 Blood Bank- EMC Group of Hospitals">
<meta property="twitter:description" content="Licensed Blood bank for each and every blood group, EMC is available for 24 hours to deal best with the emergency cases. ">
<meta property="twitter:image" content="">
  
 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/transfusion-services.php"/>
...
<!-- End Google Tag Manager (noscript) -->
      ...
      <div class="container-fluid padding-0 margin-0">
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li>
                     <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="cardiology.php">Transfusion Services ( Blood Bank )</a>
                  </li>
               </ul>
            </div>
         </div>
         <div class="spec-banner">
            ...
            <img src="assets/web-banners/blood-bank.jpg">
            <!-- <div class="container">
         ...
         <div class="container">
            <div class="row padding-35 m-0" style="margin:0;">
               <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                  <div class="overview" id="about_doclistingpage">
                     <p>Blood is the only element that has no substitute and most important for the human body. EMC hospitals have licensed blood banks for every and any blood group. 
                        We ensure that our blood banks are provisioned for every emergency and the patient does not suffer. Blood banks are open 24x7 in our hospitals and serve the best during emergency cases. 
                     </p>
                     <h4>EMC group of hospitals knowing their responsibilities take care of:</h4>
                     <ul>
                        <li>To rapidly respond to every patient in the emergency and provide with the required blood group if the availability allows else, the concerned family is informed asap.</li>
                        <li>Examining every pre-transfusion request and sample</li>
                        <li>Safely delivering and handling of blood samples or supplements.</li>
                        <li>We analyse the immunological compatibility between the patient and donor.</li>
                        <li>Selecting the accurate blood sample, in case any such medical condition arises.</li>
                        <li>Managing the stock and inventory</li>
                     </ul>
                     <p>EMC group of hospitals and its assistant staff never fail to deliver their responsibilities because we keep your health a priority. We make sure and keep a tightening check on this essential facility to make sure no patient has to suffer because of blood shortage or absence.</p>
                  </div>
				</div>
                ...
                <input id="discipline" name="department" type="hidden" value="Transfusion Services(Blood Bank)">
			  ...
			  <button type="submit" class="btn btn-primary" name="send">Submit</button>
					...
					<div class="cstm-blood-img">
						<img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/blood-bnk.jpg">
					</div>
				</div>
                  <div class="row department-of">
                        ...
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/24x7.png" alt="">
                              </div>
                              <h4 style="color: #1069af;">24x7</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/blood-cross-matching.png" alt="">
                              </div>
                              <h4 style="color: #ed1c24;">Blood Cross Matching</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/blood-grouping-typing.png" alt="">
                              </div>
                              <h4 style="color: #ed1c24;">Blood Grouping Typing</h4>
                           </div>
                        </a>
                     </div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/ffp.png" alt="">
                              </div>
                              <h4 style="color: #facb0b;">FFP
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/prpc.png" alt="">
                              </div>
                              <h4 style="color: #eb1f26;">PRBC
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/rdpc.png" alt="">
                              </div>
                              <h4 style="color: #a62622;">RDPC
                              </h4>
                           </div>
                        </a>
                     </div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/sdpc.png" alt="">
                              </div>
                              <h4 style="color: #c02026;">SDPC
                              </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">
                                 <img src="icons-scope/transfusion-services/whole-blood.png" alt="">
                              </div>
                              <h4 style="color: #b44055;">Whole Blood
                              </h4>
                           </div>
                        </a>
                     </div>
            ...
            <!--  <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
               <div class="doc_image_doctorlist">
                   <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-vivek-tandon.jpg">
                   
               
                   <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr. Vivek Tandon" data-speciality="Cardiologist" data-hospital="Hospital EMC" href="#" target="_blank">
                       <button>Book an Appointment</button>
                   </a>                <h1>DR. VIVEK TANDON </h1>
                   <p class="doctor_degree hdeading">DM (CARDIOLOGY)</p>
                    <p class="doctor_degree hdeading"><i style="font-size: 20px;" class="fa fa-volume-control-phone" aria-hidden="true"></i> +91-92160-60517</p>
               ...
               <div class="doc_image_doctorlist">
                   <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-tariq-rashid-shah.jpg">
                   
               
                   <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr. Tariq Rashid Shah" data-speciality="Cardiology" data-hospital="Hospital EMC" href="#" target="_blank">
                       <button>Book an Appointment</button>
                   </a>                <h1>DR. TARIQ RASHID SHAH </h1>
                   <p class="doctor_degree hdeading">MBBS, MD, DM, (Cardiology)</p>
                   <p class="doctor_degree hdeading"> <i style="font-size: 20px;" class="fa fa-volume-control-phone" aria-hidden="true"></i> +91- 70099-89781</p>
                   <p class="doctor_degree hdeading"> <i style="font-size: 20px;" class="fa fa-envelope" aria-hidden="true"></i> emc.treatment@gmail.com</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Transfusion Services" required="">
