...
<?php include "include/header.php"; ?>
 ...
 <div class="container-fluid bread">
    ...
    <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="digital-x-ray.php">Digital X-RAY</a></li>
 ...
 <div class="spec-banner">
    <div class="banner-gredient"></div>
     <img src="facilities-banner/facilities-06.jpg">
   <!--  <div class="container">
        <h1>Digital X-RAY</h1>
    </div> -->
</div>
...
<p>Digital X-Rays are the best and instant solutions to detect any problem in the body. Making the use of the digital electronic sensors and the capturing devices, such x-rays fruitfully replaced the conventional photographic film technique. </p>

 <p>Since it is the best diagnosis technology, EMC group of hospitals are accurately equipped to provide the facility of digital x-rays to any and every patient. Also, we always keep our techniques and pieces of equipment updated as per the international standards. </p>

<h4>Advantages of Digital X-rays:</h4>

<ul>
<li>Radiation reduction that a human body comes in contact with.</li>
<li>Affordable diagnosis technique</li>
<li>Easy and quick generation of reports</li>

</ul>

<p>Our proficient team of lab staff never fails to deliver the reports with 100% accuracy to the respective patients and never believe in the waiting system for getting the medical treatment. </p>

<p>You can avail of this medical facility 24x7 at the EMC group of hospitals and immediately have a follow-up with the concerned doctor to start your treatment process.</p>
        ...
        <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
            <div class="doc_image_doctorlist">
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="images/digital-x-ray.jpg">
