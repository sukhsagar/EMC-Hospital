...
<html lang="en">
   <head>
      ...
      <!-- Primary Meta Tags -->
      <title>Best Physiotherapy and Rehabilitation Hospital in Amritsar</title>
      <meta name="title" content="Best Physiotherapy and Rehabilitation Hospital in Amritsar">
      <meta name="description" content="Looking for a physiotherapist? EMC Hospital is known as one of the best Physiotherapy and Rehabilitation hospital in Amritsar.">
      <!-- Open Graph / Facebook -->
      <meta property="og:type" content="website">
      <meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/physiotherapy.php">
      <meta property="og:title" content="Best Physiotherapy and Rehabilitation Hospital in Amritsar">
      <meta property="og:description" content="Looking for a physiotherapist? EMC Hospital is known as one of the best Physiotherapy and Rehabilitation hospital in Amritsar.">
      <meta property="og:image" content="">
      <!-- Twitter -->
      <meta property="twitter:card" content="summary_large_image">
      <meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/physiotherapy.php">
      <meta property="twitter:title" content="Best Physiotherapy and Rehabilitation Hospital in Amritsar">
      <meta property="twitter:description" content="Looking for a physiotherapist? EMC Hospital is known as one of the best Physiotherapy and Rehabilitation hospital in Amritsar.">
      <meta property="twitter:image" content="">
      <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/physiotherapy.php"/>
      <!-- Google Tag Manager --><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-PZMZK9K');</script><!-- End Google Tag Manager -->     
   ...
   <body>
      ...
      <div class="spec-banner">
         ...
         <img src="assets/web-banners/physiotherapy.jpg"><!--     <div class="container">        <h1>Department of Physiotheraphy & Rehblitation </h1>    </div> -->
      </div>
      <div class="container">
         <div class="row padding-35 m-0" style="margin:0;">
            <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/Dr.-Shubhkaram-Deep-Kaur.jpeg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr. Shubhkaram Deep Kaur" data-speciality="Physiotheraphy" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
                               <h5>Dr. Shubhkaram Deep Kaur</h5>
                               <p ></p>
                 ...
                 <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/Ramandeep-kaur.jpg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Ramandeep Kaur" data-speciality="Physiotheraphy" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
                               <h5>Dr. Ramandeep Kaur</h5>
                               <p ></p>
                               <p ><a href="mailto:emc.treatment@gmail.com"> <i class="fa fa-envelope" aria-hidden="true"></i> emc.treatment@gmail.com</a></p>
                          </div>
                 ...
                 <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/Neha-Arora.jpg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Neha Arora" data-speciality="Physiotheraphy" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
               ...
               <div class="overview" id="about_doclistingpage">
                  <p>EMC group of hospitals has a specialisation team of physiotherapists that pay close attention to treating the patients by this art of physiotherapy without the use of any drug.Patients are cured with one-to-one engagement with our physiotherapists who emphasise patients for learning self-management skills and motivate patients for not depending on anyone. </p>
                  <p>From the best of our knowledge, our physiotherapy department seamlessly works to support every and any patient to have the fastest recovery from their original condition along with the physical testing. </p>
                  <div class="row department-of">
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/cardiovascular-rehablitation.png" alt="">                        </div>
                              <h4 style="color: #25384e;">Cardiovascular Rehablitation</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/carvical-radiculopathy.png" alt="">                        </div>
                              <h4 style="color: #26ace2;">Carvical Radiculopathy</h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/cerebral-palsy.png" alt="">                        </div>
                              <h4 style="color: #7171b5;">Cerebral Palsy</h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/cervical-low-back-pain.png" alt="">                        </div>
                              <h4 style="color: #7fc241;">Cervical  Low Back Pain                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/knee-pain.png" alt="">                        </div>
                              <h4 style="color: #c63727;">Knee Pain                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/neurological-rehablitation.png" alt="">                        </div>
                              <h4 style="color: #8597b1;">Neurological Rehablitation                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/neurousculoskeletal-rehablitation.png" alt="">                        </div>
                              <h4 style="color: #953d27;">Neurousculoskeletal Rehablitation                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/pain-management.png" alt="">                        </div>
                              <h4 style="color: #8a2269;">Pain Management                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/pivd.png" alt="">                        </div>
                              <h4 style="color: #297cbd;">PIVD                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/sciatica-pain.png" alt="">                        </div>
                              <h4 style="color: #14263a;">Sciatica Pain                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="col-md-4 col-sm-4 col-6">
                        <a href="#">
                           <div class="home-specility-section cardiology-four">
                              <div class="home-speciality-img services-Cardiology">                            <img src="icons-scope/physiotherapy/sports-injury.png" alt="">                        </div>
                              <h4 style="color: #7198d0;">Sports Injury                        </h4>
                           </div>
                        </a>
                     </div>
                     <div class="clearfix"></div>
                     <iframe width="560" height="315" src="https://www.youtube.com/embed/WOQZJwtgrps" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     <br>        
                  </div>
               </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
               <div class="form-pages_contact">
                  ...
                  <form class="mt-5" method="post" action="request-callback-form.php" onsubmit="return validateForm()">
                     <input id="discipline" name="department" type="hidden" value="Physiotherapy & Rehabilitation">							  
                     <div class="form-row">
               ...
               <style type="text/css">                                     .widget-categories ul li a {                         display: block;                        position: relative;                         padding: 14px 10px 14px 50px;                         color: #F7941D;                         font-size: 14px;                         font-weight: 600;                         text-transform: capitalize;                         margin-bottom: 2px;                         border-radius: 3px;                        background-color: #ffffff;                         -webkit-box-shadow: 0 5px 83px 0 rgba(40, 40, 40, 0.04);                         box-shadow: 0 5px 83px 0 rgba(40, 40, 40, 0.04);                         -webkit-transition: all 0.3s linear;                         transition: all 0.3s linear;                     }                     .widget-categories ul li a:hover{                        -webkit-transform: scale(1.1);                        -ms-transform: scale(1.1);                         transform: scale(1.1);                     }               </style>
            ...
            <div class="row">
               ...
               <div class="owl-carousel owl-theme bcon" id="advance-tecnology">
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/cardiac-critical-care.jpg" alt="" title=""                                class="img-responsive">                            
                  ...
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/ct-scan.jpg"                                 class="img-responsive ">                            
                           <h4>CT Scan </h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/digital-x-ray.jpg"                                 class="img-responsive">                            
                           <h4>Digital X Ray</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/eeg.jpg"                                class="img-responsive">                            
                           <h4>EEG</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/emergency.jpg"                                class="img-responsive">                            
                           <h4>Emergency</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/flat-panel-cath-lab.jpg"                                class="img-responsive">                            
                           <h4>Flat Panel Cath Lab</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/gastroentero-logy-and-hepatology.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>Gastroentero Logy and Hepatology</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/genearl-laparoscopic-surgery.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>Genearl & Laparoscopic Surgery </h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                  ...
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/nephrology.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>Nephrology</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/pharmacy.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>Pharmacy</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/physiotherpy.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>Physiotherpy</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/ambulance.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>physiotherpy</h4>
                        </div>
                     </a>
                  </div>
                  <div class="item-holder">
                     <a>
                        <div class="item-holder">
                           <img src="internal-external/x-ray.jpg" alt="" title=""                                class="img-responsive">                            
                           <h4>X Ray</h4>
                        </div>
                     </a>
                  </div>
               ...
               <div class="modal-body">
                  ...
                  <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-6 col-xs-12">            <label for="">Department</label>            <input type="text" class="form-control" id="departments" name="department" value="Physiotherapy & Rehabilitation" required="">            </div>
                     </div>
                     <div class="form-row">
