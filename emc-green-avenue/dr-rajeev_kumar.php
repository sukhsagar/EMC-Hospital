   ...
   <body>
         ...
         <div class="container-fluid bread">
            <div class="container p-0">
               <ul class="breadcrumb blog_breadcrumb">
                  ...
                  <li> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="#">Dr. Rajeev Kumar</a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="col-lg-3 col-md-12  col-sm-12">
         <div class="doctor-img">
         	<img class="img-fluid" alt="User Image" src="doctors/dr-rajeev-kumar.jpg">
         </div>
         <div class="img-dwn-cnt">
		 <h5>EXPERIENCE</h5>
		 		<p>Consultant Ansthesiologist in the Deapartment of anesthesia and critical care EMC Group of Hospitals, Amritsar since June 2019.</p>
				<p>Senior resident anesthesiologist at MGM Hospital Navi Mumbai.</p>
				<p>Senior medial officer under Department of health and family welfare at Noida 2010-2016</p>
				<p>Junior resident at department of emergency at Guru Govind Singh Government Hospital Delhi 2009 to 2010.</p>
         </div>
      </div>
      ...
      <div class="table-responsive">
         <table border="1" width="100%" class="table-doc">
            <tr>
               <td colspan="2">
                  <h3 class="doctor-hding">Dr. Rajeev Kumar</h3>
               </td>
            </tr>
            <tr>
               ...
               <td>
                  <p>MD Anaesthesiology MGM Navi Mumbai year of Passing April, 2019 , ELMCH, Lucknow year of Passing April, 2008</p>
               </td>
            </tr>
         ...
         <table border="1" width="100%" class="table-doc">
            ...
            <tr>
               <td>
                  <div class="cnt-doctorss">
                <ul>
					<li>General Anesthesia and regional anesthesia for high risk Neuro Surgery, Cancer Surgery and Ortho Surgery</li>
					<li>Anesthesia for difficult airways including laser surgery on larynx and trachea </li>
					<li>Pediatric Anesthesia</li>
					<li>USG guided blocks</li>
					<li>Epidual Anelagesia for Labour and total knee replacement (walking epidural)</li>
					<li>American heart association: ACLS / BLS provider</li>
					<li>Airway management, cardiac and pulmonary resuscitation.</li>
					<li>Advance life support and pain management</li>
					<li>Ventilation and hemodynamic monitoring in ICU</li>
             ...
             <tr>
               <td>
                  <div class="cnt-doctorss">
          <p><b>POSTER:</b></p>
					<p>Management of patient posted for breast surgery under thoracic par vertebralblock with post-  Operative Analgesia</p>
					<p><b>PAPER:</b></p>
					<p>Comparison of Ondansetron with Ondansetron and Dexamethasone in prevention of  post-operative nausea and vomiting (ponv) in laparoscopic surgeries</p>
					<p>Comparison Of Unilateral Spinal And Continuous Spinal Anesthesia For Hip Surgery In Elderly Patients</p>
					<p><b>THESIS:</b></p>
					<p>A comparison of two Supraglottic airway devices laryngeal mask airway classic versus I-gel a prospective, randomized, controlled, single blind comparative study.</p>
					<p><b>PARTICIPATION:</b></p>
					<p>ISPCCON 2017 Mumbai</p>
					<p>RACE Chennai 2018</p>
					<p>MASCON Mumbai2018</p>
					<p>18TH NORTH Zone ISACON Amritsar 2020.</p>
					<p><b>PUBLICATION / BLOG</b></p>
					<p>Case report for anesthesia management for incisional hernia repair in case of severe Kyphoscoliosis with TB spine and asthma with severely deranged pulmonary function test. 2017</p>
					<p>A Retrospective Analysis On The Cause & Factors Affecting Still Births In A Tertiary Care Centre In Navi Mumbai 2017</p>
					<p>Comparative study of Metoclopramide with Ondansetron and examethasone in prevention of post-operative nausea and vomiting in abdominal surgeries 2018</p>
					<p>Preoperative use of intra-aortic balloon pump in multi vessels coronary artery disease patients undergoing coronary artery bypass graft.2018</p>
					<p>Assessment Of Efficacy Of Dexamethasone As An Adjuvant To Bupivacaine for Spinal Anesthesia 2019</p>
                     <div>
               </td>
            </tr>
			 <tr>
             ...
             <tr>
               <td>
                  <div class="cnt-doctorss">
          <p>1. INDIAN MEDICAL ASSOCIATION SINCE 2010</p>
				<p>2. INDIAN SOCIETY OF ANESTHESIA SINCE 2018</p>
                     <div>
               </td>
            </tr>
         </table>
