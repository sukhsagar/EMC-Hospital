...
<title>ENT Oncology Hospital in Amritsar | EMC Hospital</title>

<meta name="title" content="ENT Oncology Hospital in Amritsar | EMC Hospital">

<meta name="description" content="EMC Hospital is the best ENT Oncology Hospital in Amritsar. The team consists of renowned ENT specialist doctors in Amritsar.">
...
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/ent-oncology.php">

<meta property="og:title" content="ENT Oncology Hospital in Amritsar | EMC Hospital">

<meta property="og:description" content="EMC Hospital is the best ENT Oncology Hospital in Amritsar. The team consists of renowned ENT specialist doctors in Amritsar.">
...
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/ent-oncology.php">

<meta property="twitter:title" content="ENT Oncology Hospital in Amritsar | EMC Hospital">

<meta property="twitter:description" content="EMC Hospital is the best ENT Oncology Hospital in Amritsar. The team consists of renowned ENT specialist doctors in Amritsar.">

<meta property="twitter:image" content="">

  

 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/ent-oncology.php"/>
    ...
    <div class="container p-0">
        ...
        <ul class="breadcrumb blog_breadcrumb">
            ...
            <li>
                ...
                <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="neck-ent-surgery.php">Department of Head & Neck Surgery(ENT)</a></li>
...
<div class="spec-banner">
    ...
    <img src="assets/web-banners/oncology-ent.jpg">

   <!--  <div class="container">

        <h1>Department of Head & Neck Surgery(ENT)</h1>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/dr-parladd-duggal.jpg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Prahad Duggal" data-speciality="ENT" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
                               <h5>Dr.Prahad Duggal</h5>
                               <p >MS, ENT</p>
                 ...
                 <div class="col-lg-6">
                    ...
                    <div class="doc-cardx">
                          ...
                          <div class="doc_image_doctorlist">
                              <img class="img-responsive" width="100%" src="doctors/dr-rk-saini.jpg">
                              <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.R.K Saini" data-speciality="ENT" data-hospital="Hospital EMC" href="#" target="_blank">
                              <button>Book an appointment</button>
                              </a>     
                          </div>
                          <div class="doc-details">
...
<p>The department of head and neck surgery deals with a vast range of problems that reside within the neck, head and ENT(ear, nose and throat). </p>



<p>Every treatment procedure differs for each patient taking into consideration the extent of illness and the patient’s history, health and resources available. Every patient is examined individually and depending on their particular conditions, the patients are suggested with the treatment procedures. </p>

<p>Though many people get confused when they are recommended to the general surgery ward and think they can be cured only through surgery. But this may not be the case, as patients are not always advised with operations, and sometimes they require just consultation and right medical treatment.</p>    



<p>Under the guidance of Dr. R.K Saini and Dr. Prahad Duggal, the department of the head, neck and ENT surgery is selflessly serving the patients from decades.</p> 



<p>Our hospitals are well-equipped with all the modern technologies to provide high-quality medical facilities and perform all the emergency surgeries successfully. </p>  
    ...
    <br>
                ...
                <a href="cardiology.php">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/ent/cochlear-implantation.png" alt="">

                        </div>

                        <h4 style="color: #2995ec;">Cochlear Implantation</h4>
                ...
                <a href="cardiologist.php">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/ent/ear-and-skull-based-surgery.png" alt="">

                        </div>

                        <h4 style="color: #000;">Ear and Skull Based Surgery</h4>
                ...
                <a href="gastroenterology.php">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/ent/nasal-endoscopy.png" alt="">

                        </div>

                        <h4 style="color: #df8188;">Nasal Endoscopy</h4>
                ...
                <a href="nephrology.php">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/ent/thyroid-surgery.png" alt="">

                        </div>

                        <h4 style="color: #b71411;">Thyroid Surgery     
                ...
                <a href="nephrology.php">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/ent/voice-disorder.png" alt="">

                        </div>

                        <h4 style="color: #eb7a74;">Voice Disorder
       ...
       <div class="clearfix"></div>
        ...
        <div class="form-pages_contact">
                ...
                <input id="discipline" name="department" type="hidden" value="ENT / ENT Oncology">
		...
		<!-- <div class="row">
			...
			<div class="col-lg-3 col-xs-12">
                ...
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-parladd-duggal.jpg">

                



                <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr. Prahad Duggal" data-speciality="MS, E.N.T" data-hospital="Hospital EMC" href="#" target="_blank">

                    <button>Book an Appointment</button>

                </a>                <h1>Dr. Prahad Duggal </h1>

                <p class="doctor_degree">MS, E.N.T</p>
			...
			<div class="col-lg-3 col-xs-12">
                ...
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-rk-saini.jpg">

                



                <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr. R.K Saini" data-speciality="MS, E.N.T" data-hospital="Hospital EMC" href="#" target="_blank">

                    <button>Book an Appointment</button>

                </a>                <h1>Dr. R.K Saini </h1>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="ENT / ENT Oncology" required="">
