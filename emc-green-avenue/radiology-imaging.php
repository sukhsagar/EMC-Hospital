...
<title>X-Ray and CT Scan in Amritsar | EMC Hospital</title>

<meta name="title" content="X-Ray and CT Scan in Amritsar | EMC Hospital">

<meta name="description" content="Get complete X-Ray Radiography and CT Scan in Amritsar at EMC Hospital. Book an appointment now.">
...
<meta property="og:url" content="https://emchospital.co.in/emc-green-avenue/radiology-imaging.php">

<meta property="og:title" content="X-Ray and CT Scan in Amritsar | EMC Hospital">

<meta property="og:description" content="Get complete X-Ray Radiography and CT Scan in Amritsar at EMC Hospital. Book an appointment now.">
...
<meta property="twitter:url" content="https://emchospital.co.in/emc-green-avenue/radiology-imaging.php">

<meta property="twitter:title" content="X-Ray and CT Scan in Amritsar | EMC Hospital">

<meta property="twitter:description" content="Get complete X-Ray Radiography and CT Scan in Amritsar at EMC Hospital. Book an appointment now.">

<meta property="twitter:image" content="">

  

 <link rel="canonical" href="https://emchospital.co.in/emc-green-avenue/radiology-imaging.php"/>
    ...
    <div class="container p-0">
        ...
        <ul class="breadcrumb blog_breadcrumb">
            ...
            <li>
                ...
                <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="radiology-imaging.php">Radiology & imaging</a></li>
...
<div class="spec-banner">
    ...
    <img src="assets/web-banners/radiology-imaging.jpg">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="doc-cardx">
                            ...
                            <div class="doc_image_doctorlist">
                               <img class="img-responsive" width="100%" src="doctors/dr-jaipal-singh.jpg">
                               <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr.Jaipal Singh" data-speciality="RADIOLOGY" data-hospital="Hospital EMC" href="#" target="_blank">
                               <button>Book an appointment</button>
                               </a>    
                            </div>

                             <div class="doc-details">
                                  <h5>Dr. Jaipal Singh</h5>
                                  <p>MBBS, DNB RADIOLOGY</p>
...
<p>Radiology is the field of medical science that makes the use of imaging technology to diagnose the human body for detecting diseases and treating them. The area is broadly categorized into two categories that are diagnostic and interventional radiology.</p>



<p>The doctors who specialized in this field are referred to as radiologists </p>
...
<p>EMC group of hospitals have the proficient radiologists, and under the guidance of Dr. Jaipal Singh, the department never fails to provide accurate results to the patients. Our hospitals are well equipped with state-of-art technology and make sure we keep up with every latest technology and instrumentation.
...
<p>With clinical excellence, unobstructed focus and affordable costs, our department is delivering quality healthcare services 24X7.</p>   
    ...
    <br>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/radiology-imaging/ct-angiography.png" alt="">

                        </div>

                        <h4 style="color: #acc037;">CT Angiography</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/radiology-imaging/mri-with-multiple-imaging-protocols-relevant-to-oncology.png" alt="">

                        </div>

                        <h4 style="color: #b45b27;">MRI with Multiple Imaging Protocols Relevant to Oncology</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/radiology-imaging/multiphase-ct-scans.png" alt="">

                        </div>

                        <h4 style="color: #db4198;">Multiphase CT Scans</h4>
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/radiology-imaging/pet-ct scans.png" alt="">

                        </div>

                        <h4 style="color: #3a53a4;">PET-CT scans
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/radiology-imaging/virtual-endoscopy.png" alt="">

                        </div>

                        <h4 style="color: #62c7c6;">Virtual Endoscopy
                ...
                <a href="#">
                    ...
                    <div class="home-specility-section cardiology-four">
                        ...
                        <div class="home-speciality-img services-Cardiology">
                            ...
                            <img src="icons-scope/radiology-imaging/x-rays.png" alt="">

                        </div>

                        <h4 style="color: #bf2426;">X-Rays
       ...
       <div class="clearfix"></div>
        ...
        <div class="form-pages_contact">
                ...
                <input id="discipline" name="department" type="hidden" value="Radiology & Imaging">
		...
		<!-- <div class="row">
			...
			<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                ...
                <img class="img-responsive" width="100%" style="border-radius: 3px;" src="doctors/dr-jaipal-singh.jpg">

                



                <a data-toggle="modal" data-target="#exampleModalCenter" data-id="Dr. Jaipal Singh" data-speciality="Cardiologist" data-hospital="Hospital EMC" href="#" target="_blank">

                    <button>Book an Appointment</button>

                </a>                <h1>Dr. Jaipal Singh </h1>

                <p class="doctor_degree">MBBS, DNB RADIOLOGY</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mt-5 callmodalss" method="post" action="request-callback-form-department.php" onsubmit="return validateForm()">
            ...
            <input type="text" class="form-control" id="departments" name="department" value="Radiology & Imaging" required="">
